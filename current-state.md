...
- Destructuring binding runtime support is implemented for the current simple identifier-only subset: dense array declarations, object shorthand/identifier alias declarations, ordinary function parameter patterns, and arrow parameter patterns have Node/iwasm differential coverage. Defaults, nested patterns, elisions, rest binding, and broad iterator semantics remain issue-251 unsupported diagnostics.
