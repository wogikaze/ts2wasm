...
- `host.eval.direct` manifest / host-deny checks are implemented, and a
  ...
  functions remain callable across eval calls.
  ...
  TDZ semantics. New declaration landing and full TDZ modeling remain open.
