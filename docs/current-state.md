...
- dynamic `Function` constructor compile and statically visible host-handle
  ...
  same host object is returned repeatedly and carries handles as wasm object
...
completeness, broader host Function handle object mutation/error bridging, and
