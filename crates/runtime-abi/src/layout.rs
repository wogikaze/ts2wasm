...
impl Layout {
    ...
    pub const WELL_KNOWN_SYMBOL_COUNT: u32 = 16;
    ...
    pub const WELL_KNOWN_SYMBOL_CACHE_SIZE: u32 = 64; // 16 * 4
    ...
    /// Well-known symbol index for Symbol.metadata
    pub const WK_SYMBOL_METADATA: u32 = 15;
}
