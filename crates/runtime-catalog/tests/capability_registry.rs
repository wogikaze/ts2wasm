...
const HOST_IMPORT_RUNTIME_CASES: &[RuntimeImportCase] = &[
    ...
    RuntimeImportCase {
        runtime_fn: RuntimeFn::DateToDateString,
        imports: &[HostImport::DateToDateString],
        capabilities: &[Capability::HostDateToDateString],
    },
    RuntimeImportCase {
        runtime_fn: RuntimeFn::DateToTimeString,
    ...
    RuntimeImportCase {
        runtime_fn: RuntimeFn::EvalDirectHost,
        imports: &[HostImport::EvalDirect],
        capabilities: &[Capability::HostEvalDirect],
    },
    RuntimeImportCase {
        runtime_fn: RuntimeFn::EvalIndirectHost,
    ...
    RuntimeImportCase {
        runtime_fn: RuntimeFn::FunctionCallHost,
