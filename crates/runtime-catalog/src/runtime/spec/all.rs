...
match self {
            ...
            Self::MathHypot => RuntimeSpec {
                symbol: "$math_hypot",
                deps: MATH_HYPOT_DEPS,
                imports: NO_IMPORTS,
                capability: NO_CAPS,
                runtime_strings: NO_RUNTIME_STRINGS,
                result: RuntimeResult::Value,
