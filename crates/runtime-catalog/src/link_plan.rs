...
const NODE_SHIM_IMPORT_CAPABILITIES: &[(HostImport, Capability)] = &[
    (HostImport::FsReadFileSync, Capability::HostFsReadFileSync),
    (HostImport::FsWriteFileSync, Capability::HostFsWriteFileSync),
    (
        HostImport::FsAppendFileSync,
        Capability::HostFsAppendFileSync,
    ),
    (HostImport::ProcessExit, Capability::HostProcessExit),
    (HostImport::PathJoin, Capability::HostPathJoin),
    (HostImport::PathResolve, Capability::HostPathResolve),
    (HostImport::PathBasename, Capability::HostPathBasename),
    (HostImport::PathDirname, Capability::HostPathDirname),
    (
        HostImport::CryptoRandomBytes,
        Capability::HostCryptoRandomBytes,
    ),
    (HostImport::EncodeURI, Capability::HostEncodeURI),
    (HostImport::DecodeURI, Capability::HostDecodeURI),
    (HostImport::Escape, Capability::HostEscape),
    (HostImport::Unescape, Capability::HostUnescape),
    (HostImport::DateToString, Capability::HostDateToString),
    (
        HostImport::DateGetLocalTimeField,
        Capability::HostDateGetLocalTimeField,
    ),
    (HostImport::DateToISOString, Capability::HostDateToISOString),
    (
    ...
    (HostImport::DateParse, Capability::HostDateParse),
    (HostImport::DateUTC, Capability::HostDateUTC),
    (HostImport::MathAcos, Capability::HostMathAcos),
    (HostImport::MathAcosh, Capability::HostMathAcosh),
    (HostImport::MathAsin, Capability::HostMathAsin),
    (HostImport::MathAsinh, Capability::HostMathAsinh),
    (HostImport::MathAtan, Capability::HostMathAtan),
    (HostImport::MathAtanh, Capability::HostMathAtanh),
    (HostImport::MathCos, Capability::HostMathCos),
    (HostImport::MathCosh, Capability::HostMathCosh),
    (HostImport::MathExp, Capability::HostMathExp),
    (HostImport::MathExpm1, Capability::HostMathExpm1),
    (HostImport::MathLog, Capability::HostMathLog),
    (HostImport::MathLog10, Capability::HostMathLog10),
    (HostImport::MathLog1p, Capability::HostMathLog1p),
    (HostImport::MathLog2, Capability::HostMathLog2),
    (HostImport::MathSin, Capability::HostMathSin),
    ...
    (HostImport::ReflectApply, Capability::HostReflectApply),
    (
    ...
    (HostImport::FunctionCall, Capability::HostFunctionCall),
    (
    ...
    (HostImport::StringNormalize, Capability::HostStringNormalize),
];

fn node_shim_import_to_capability(import: &HostImport) -> Option<Capability> {
    NODE_SHIM_IMPORT_CAPABILITIES
        .iter()
        .find_map(|(candidate, capability)| (candidate == import).then_some(*capability))
}
