//! Array.prototype.find — observable builtin algorithm.
//!
//! ECMAScript spec steps:
//! 1. Let O be ToObject(this value)
//! 2. Let len be ToLength(Get(O, "length"))
//! 3. If IsCallable(predicate) is false, throw TypeError
//! 4. Let k = 0
//! 5. Repeat while k < len:
//!    a. Let Pk be ToString(k)
//!    b. Let kValue be Get(O, Pk)
//!    c. Let testResult be Call(predicate, thisArg, [kValue, k, O])
//!    d. If ToBoolean(testResult) is true, return kValue
//!    e. k++
//! 6. Return undefined
...
pub fn build_array_find() -> SpecAlgoProgram {
    let mut env = AlgoBuilder::new();
    let obj = env.alloc_local();
    let predicate = env.alloc_local();
    ...
    // 5c. Call(predicate, thisArg, [kValue, k, O])
    env.call_specop(SpecOp::Call { callee: predicate.0, this: obj.0, args: k.0 }, vec![predicate, obj]);
