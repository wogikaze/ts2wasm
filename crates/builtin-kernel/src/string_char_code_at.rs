//! String.prototype.charCodeAt — observable builtin algorithm.
//!
//! ECMAScript spec steps:
//! 1. Let O be ToObject(this value)
//! 2. Let len be ToLength(Get(O, "length"))
//! 3. Let pos be ToIntegerOrInfinity(pos)
//! 4. If pos < 0 or pos ≥ len, return NaN
//! 5. Return Get(O, ToString(pos)) as character code

use ts2wasm_spec_kernel::algorithm::{AlgoBuilder, SpecAlgoProgram};
use ts2wasm_spec_kernel::SpecOp;

pub fn build_string_char_code_at() -> SpecAlgoProgram {
