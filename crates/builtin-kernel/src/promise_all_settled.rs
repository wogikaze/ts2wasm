//! Promise.allSettled — observable builtin algorithm.
//!
...
//!       onFulfilled = CreateSettledResult("fulfilled", value)
//!       onRejected = CreateSettledResult("rejected", reason)
//! 7. Return promiseCapability.[[Promise]]

use ts2wasm_spec_kernel::algorithm::{AlgoBuilder, SpecAlgoProgram};
use ts2wasm_spec_kernel::SpecOp;

pub fn build_promise_all_settled() -> SpecAlgoProgram {
