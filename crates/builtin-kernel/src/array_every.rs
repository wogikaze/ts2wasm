//! Array.prototype.every — observable builtin algorithm.
//!
...
//!    d. If ToBoolean(testResult) is false, return false
//!    e. k++
//! 6. Return true
...
pub fn build_array_every() -> SpecAlgoProgram {
