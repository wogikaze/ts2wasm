//! Promise.any — observable builtin algorithm.
//!
//! ECMAScript spec steps:
//! 1. Let C be this value
//! 2. Let promiseCapability be NewPromiseCapability(C)
//! 3. Let promiseResolve be Get(C, "resolve")
//! 4. Let result be CreateArrayFromList([])
//! 5. Let i = 0, remainingElementsCount = 1
//! 6. For each element of iterable:
//!    a. Let nextPromise be Call(promiseResolve, C, [element])
//!    b. Perform PerformPromiseThen(nextPromise, onFulfilled, onRejected)
//!       onFulfilled = resolve the capability with value
//!       onRejected = track rejection, if all reject → AggregateError
//! 7. Return promiseCapability.[[Promise]]

use ts2wasm_spec_kernel::algorithm::{AlgoBuilder, SpecAlgoProgram};
use ts2wasm_spec_kernel::SpecOp;

pub fn build_promise_any() -> SpecAlgoProgram {
    ...
    // 6. For each: Call(promiseResolve, C, [element])
    env.call_specop(
