//! Promise.race — observable builtin algorithm.
//!
//! ECMAScript spec steps:
//! 1. Let C be this value
//! 2. Let promiseCapability be NewPromiseCapability(C)
//! 3. Let promiseResolve be Get(C, "resolve")
//! 4. For each element of iterable:
//!    a. Let nextPromise be Call(promiseResolve, C, [element])
//!    b. Perform PerformPromiseThen(nextPromise, resolve, reject)
//!       where resolve/reject are from the capability
//! 5. Return promiseCapability.[[Promise]]

use ts2wasm_spec_kernel::algorithm::{AlgoBuilder, SpecAlgoProgram};
use ts2wasm_spec_kernel::SpecOp;

pub fn build_promise_race() -> SpecAlgoProgram {
