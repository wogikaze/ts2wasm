...
const KNOWN_FEATURES: &[(&str, &str)] = &[
    ...
    ("String.prototype.charAt", "issue-5004"),
    ("String.prototype.charCodeAt", "issue-5004"),
    ("String.prototype.endsWith", "issue-5004"),
    ("String.prototype.includes", "issue-5004"),
    ("String.prototype.indexOf", "issue-5004"),
    ("String.prototype.matchAll", "issue-5004"),
    ("String.prototype.padEnd", "issue-5004"),
    ("String.prototype.padStart", "issue-5004"),
    ("String.prototype.repeat", "issue-5004"),
    ("String.prototype.replaceAll", "issue-5004"),
    ("String.prototype.slice", "issue-5004"),
    ("String.prototype.split", "issue-5004"),
    ("String.prototype.startsWith", "issue-5004"),
    ("String.prototype.substring", "issue-5004"),
    ("String.prototype.toLocaleLowerCase", "issue-5004"),
    ("String.prototype.toLocaleUpperCase", "issue-5004"),
    ("String.prototype.toLowerCase", "issue-5004"),
    ("String.prototype.toUpperCase", "issue-5004"),
