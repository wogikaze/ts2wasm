...
const KNOWN_FEATURES: &[(&str, &str)] = &[
    ...
    ("Object.entries", "issue-5000"),
    ("Object.is", "issue-5000"),
    ("Promise", "issue-5025"),
    ...
    ("class", "issue-421"),
    ("class-fields-public", "issue-421"),
    ("class-fields-private", "issue-421"),
    ("class-fields-private-in", "issue-421"),
    ("class-static-fields-public", "issue-421"),
    ("class-static-fields-private", "issue-421"),
    ("generators", "issue-401"),
    ("async-functions", "issue-416"),
    ("BigInt", "issue-5000"),
    ("DataView", "issue-408"),
    ("Float16Array", "issue-408"),
    ("Float32Array", "issue-408"),
    ("Float64Array", "issue-408"),
    ("Int16Array", "issue-408"),
    ("Int32Array", "issue-408"),
    ("Int8Array", "issue-408"),
    ("SharedArrayBuffer", "issue-408"),
    ("TypedArray", "issue-408"),
    ("Uint16Array", "issue-408"),
    ...
    ("Array.prototype.values", "issue-5000"),
    ("Array.prototype.at", "issue-5000"),
    ("Array.prototype.flat", "issue-5000"),
    ("Array.prototype.includes", "issue-5000"),
    ("array-find-from-last", "issue-5000"),
    ("Array.prototype.flatMap", "issue-5000"),
    ("Object.hasOwn", "issue-5000"),
    ("change-array-by-copy", "issue-5000"),
    ("Symbol.toStringTag", "issue-5000"),
    ("__proto__", "issue-5000"),
    ("__getter__", "issue-5000"),
    ("__setter__", "issue-5000"),
    // --- string prototype features (implemented / partially supported) ---
    ("String.prototype.at", "issue-5000"),
    ("String.prototype.charAt", "issue-5000"),
    ("String.prototype.charCodeAt", "issue-5000"),
    ("String.prototype.endsWith", "issue-5000"),
    ("String.prototype.includes", "issue-5000"),
    ("String.prototype.indexOf", "issue-5000"),
    ("String.prototype.padEnd", "issue-5000"),
    ("String.prototype.padStart", "issue-5000"),
    ("String.prototype.repeat", "issue-5000"),
    ("String.prototype.replaceAll", "issue-5000"),
    ("String.prototype.slice", "issue-5000"),
    ("String.prototype.split", "issue-5000"),
    ("String.prototype.startsWith", "issue-5000"),
    ("String.prototype.substring", "issue-5000"),
    ("String.prototype.toLowerCase", "issue-5000"),
    ("String.prototype.toUpperCase", "issue-5000"),
    ("String.prototype.toLocaleLowerCase", "issue-5000"),
    ("String.prototype.toLocaleUpperCase", "issue-5000"),
    ("String.prototype.trimEnd", "issue-5000"),
    ("String.prototype.trimStart", "issue-5000"),
    ("String.prototype.isWellFormed", "issue-5000"),
    ("String.prototype.toWellFormed", "issue-5000"),
    ...
    // --- language core features (fundamental JS, used across many tests) ---
    ("for-of", "issue-5000"),
    ("let", "issue-5000"),
    ("new.target", "issue-5000"),
    ("rest-parameters", "issue-5000"),
    ("super", "issue-5000"),
    ("template", "issue-5000"),
    ("optional-catch-binding", "issue-5000"),
    ("optional-chaining", "issue-5000"),
    ("error-cause", "issue-5000"),
    ("AggregateError", "issue-5000"),
    ("Promise.any", "issue-5000"),
    ("Promise.prototype.finally", "issue-5000"),
    ("Symbol.hasInstance", "issue-5000"),
    ("Symbol.prototype.description", "issue-5000"),
    ("String.fromCodePoint", "issue-5000"),
    ("Reflect.set", "issue-5025"),
    ("Reflect.setPrototypeOf", "issue-5025"),
    ("for-in-order", "issue-5000"),
    ("json-superset", "issue-5000"),
    ("well-formed-json-stringify", "issue-5000"),
    ("class-static-block", "issue-421"),
    ("export-star-as-namespace-from-module", "issue-5000"),
];
