...
impl WatEmitter<'_> {
    ...
    pub(super) fn emit_dispatch_core(&mut self, f: RuntimeFn, wat: &mut String) {
        match f {
            ...
            RuntimeFn::ConsoleGroupStart => self.emit_console_group_start(wat),
            RuntimeFn::ConsoleGroupEndFn => self.emit_console_group_end(wat),
            RuntimeFn::ConsoleTimeStart => self.emit_console_time_start(wat),
            RuntimeFn::ConsoleTimeEndFn => self.emit_console_time_end(wat),
            RuntimeFn::ConsoleCountImpl => self.emit_console_count(wat),
            RuntimeFn::ConsoleCountResetImpl => self.emit_console_count_reset(wat),
            ...
            RuntimeFn::GlobalParseInt => self.emit_parse_int(wat),
            RuntimeFn::GlobalParseFloat => self.emit_parse_float(wat),
            ...
            RuntimeFn::NumberToStringRadix => self.emit_number_to_string(wat),
