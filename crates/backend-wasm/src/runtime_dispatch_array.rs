...
impl WatEmitter<'_> {
    ...
    pub(super) fn emit_dispatch_array(&mut self, f: RuntimeFn, wat: &mut String) {
        match f {
            ...
            RuntimeFn::ArrayGrowTo => self.emit_array_grow_to(wat),
            ...
            RuntimeFn::ArraySortLexicographic => self.emit_array_sort_lexicographic(wat),
            ...
            RuntimeFn::TypedArrayCtorFromBuffer => self.emit_typed_array_ctor_from_buffer(wat),
            ...
            RuntimeFn::DataViewSetInt8 => self.emit_dataview_set_int8(wat),
            RuntimeFn::DataViewGetUint8 => self.emit_dataview_get_uint8(wat),
            RuntimeFn::DataViewSetUint8 => self.emit_dataview_set_uint8(wat),
            ...
            RuntimeFn::DataViewGetUint32 => self.emit_dataview_get_uint32(wat),
            RuntimeFn::DataViewSetUint32 => self.emit_dataview_set_uint32(wat),
            RuntimeFn::DataViewGetFloat32 => self.emit_dataview_get_float32(wat),
            ...
            RuntimeFn::DataViewGetFloat16 => self.emit_dataview_get_float16(wat),
            RuntimeFn::DataViewSetFloat16 => self.emit_dataview_set_float16(wat),
            ...
            RuntimeFn::DataViewGetBuffer => self.emit_dataview_get_buffer(wat),
            RuntimeFn::DataViewGetByteOffset => self.emit_dataview_get_byte_offset(wat),
