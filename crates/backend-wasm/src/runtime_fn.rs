...
pub(crate) const fn runtime_fn_from_builtin(builtin: BuiltinId) -> RuntimeFn {
    match builtin {
        ...
        BuiltinId::ConsoleGroup => RuntimeFn::ConsoleGroupStart,
        BuiltinId::ConsoleGroupEnd => RuntimeFn::ConsoleGroupEndFn,
        BuiltinId::ConsoleGroupCollapsed => RuntimeFn::ConsoleGroupStart,
        BuiltinId::ConsoleTime => RuntimeFn::ConsoleTimeStart,
        BuiltinId::ConsoleTimeLog => RuntimeFn::ConsoleTimeEndFn,
        BuiltinId::ConsoleTimeEnd => RuntimeFn::ConsoleTimeEndFn,
        BuiltinId::ConsoleCount => RuntimeFn::ConsoleCountImpl,
        BuiltinId::ConsoleCountReset => RuntimeFn::ConsoleCountResetImpl,
        BuiltinId::ConsoleTrace => RuntimeFn::LogError,
        ...
        BuiltinId::ParseInt => RuntimeFn::GlobalParseInt,
        BuiltinId::ParseFloat => RuntimeFn::GlobalParseFloat,
