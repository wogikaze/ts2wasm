...
"#,
  ...
  (func $date_get_utc_date (param $date i32) (result i32)
    ...
    (if (i32.ge_s (local.get $days) (i32.const 0))
        ...
        (block $year_done
          (loop $year_loop
            ...
            (if (i32.eqz (i32.rem_s (local.get $year) (i32.const 4)))
              (then
                (if (i32.rem_s (local.get $year) (i32.const 100))
      ...
      (else
        (local.set $date_val (i32.add (i32.const 32) (local.get $days)))))
