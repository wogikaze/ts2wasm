...
"#,
    ...
    pub(super) fn emit_date_parse(&self, wat: &mut String) {
        wat.push_str(&format!(
            r#"
  (func $date_parse (param $source i32) (result i32)
    (i32.or
      (i32.shl
        (call $host_date_parse (local.get $source))
...
"#,
    ...
    pub(super) fn emit_date_utc(&self, wat: &mut String) {
        wat.push_str(&format!(
            r#"
  (func $date_utc
    (param $year i32)
    ...
    (i32.or
      (i32.shl
        (call $host_date_utc
          ...
          (i32.shr_s (local.get $month) (i32.const {number_shift}))
          (i32.shr_s (local.get $date) (i32.const {number_shift}))
          (i32.shr_s (local.get $hours) (i32.const {number_shift}))
          (i32.shr_s (local.get $minutes) (i32.const {number_shift}))
          (i32.shr_s (local.get $seconds) (i32.const {number_shift}))
          (i32.shr_s (local.get $ms) (i32.const {number_shift})))
        (i32.const {number_shift}))
      (i32.const {number_tag})))
"#,
            number_shift = ValueTag::NUMBER_SHIFT,
...
"#,
  ...
  (func $date_get_utc_date (param $date i32) (result i32)
    ...
    (if (i32.lt_s (local.get $r) (i32.const 0))
      (then (local.set $days (i32.sub (local.get $days) (i32.const 1)))))
    ;; positive days: compute year, month, day
    (if (i32.ge_s (local.get $days) (i32.const 0))
      (then
        ;; find year
        ...
        (block $year_done
          (loop $year_loop
            ...
            (if (i32.eqz (i32.rem_s (local.get $year) (i32.const 400)))
              (then (local.set $is_leap (i32.const 1))))
            (if (i32.lt_u (local.get $rem_days) (i32.add (i32.const 365) (local.get $is_leap)))
              (then (br $year_done)))
            (local.set $rem_days
              (i32.sub (local.get $rem_days) (i32.add (i32.const 365) (local.get $is_leap))))
...
"#,
  ...
  (func $date_get_utc_month (param $date i32) (result i32)
    ...
    (if (i32.lt_s (local.get $r) (i32.const 0))
      (then (local.set $days (i32.sub (local.get $days) (i32.const 1)))))
    ;; positive days: compute year and month
    (if (i32.ge_s (local.get $days) (i32.const 0))
      (then
        ;; find year
        (local.set $year (i32.const 1970))
...
"#,
  ...
  (func $date_get_utc_full_year (param $date i32) (result i32)
    ...
    (if (i32.lt_s (local.get $r) (i32.const 0))
      (then (local.set $days (i32.sub (local.get $days) (i32.const 1)))))
    ;; positive days: compute year via loop
    (if (i32.ge_s (local.get $days) (i32.const 0))
      (then
        (local.set $year (i32.const 1970))
        (local.set $rem_days (local.get $days))
...
"#,
    ...
    pub(super) fn emit_date_get_timezone_offset(&self, wat: &mut String) {
        wat.push_str(&format!(
            r#"
  (func $date_get_timezone_offset (param $date i32) (result i32)
    (local $epoch_ms i32)
    (if (i32.ne (i32.and (local.get $date) (i32.const {tag_mask})) (i32.const {object_tag}))
      (then (return (i32.const {undefined}))))
    (local.set $epoch_ms
      (i32.shr_s
        (i32.load
          (i32.add (i32.and (local.get $date) (i32.const {heap_mask})) (i32.const {epoch_offset})))
        (i32.const {number_shift})))
    (i32.or (i32.shl (call $host_date_get_timezone_offset (local.get $epoch_ms)) (i32.const {number_shift})) (i32.const {number_tag})))
"#,
            tag_mask = ValueTag::TAG_MASK,
            object_tag = ValueTag::OBJECT,
            undefined = ValueTag::UNDEFINED,
...
"#,
    ...
    pub(super) fn emit_date_to_date_string(&self, wat: &mut String) {
        wat.push_str(&format!(
            r#"
  (func $date_to_date_string (param $date i32) (result i32)
    (local $epoch_ms i32)
    (if (i32.ne (i32.and (local.get $date) (i32.const {tag_mask})) (i32.const {object_tag}))
      (then (return (i32.const {undefined}))))
    (local.set $epoch_ms
      (i32.shr_s
        (i32.load
          (i32.add (i32.and (local.get $date) (i32.const {heap_mask})) (i32.const {epoch_offset})))
        (i32.const {number_shift})))
    (call $host_date_to_date_string (local.get $epoch_ms)))
"#,
            tag_mask = ValueTag::TAG_MASK,
            object_tag = ValueTag::OBJECT,
            undefined = ValueTag::UNDEFINED,
    ...
    pub(super) fn emit_date_to_time_string(&self, wat: &mut String) {
        wat.push_str(&format!(
            r#"
  (func $date_to_time_string (param $date i32) (result i32)
    (local $epoch_ms i32)
    (if (i32.ne (i32.and (local.get $date) (i32.const {tag_mask})) (i32.const {object_tag}))
      (then (return (i32.const {undefined}))))
    (local.set $epoch_ms
      (i32.shr_s
        (i32.load
          (i32.add (i32.and (local.get $date) (i32.const {heap_mask})) (i32.const {epoch_offset})))
        (i32.const {number_shift})))
    (call $host_date_to_time_string (local.get $epoch_ms)))
"#,
            tag_mask = ValueTag::TAG_MASK,
            object_tag = ValueTag::OBJECT,
            undefined = ValueTag::UNDEFINED,
    ...
    (local.set $epoch_ms
      (i32.shr_s
        (i32.load
          (i32.add (i32.and (local.get $date) (i32.const {heap_mask})) (i32.const {epoch_offset})))
        (i32.const {number_shift})))
    (call $host_date_get_year (local.get $epoch_ms)))
"#,
            tag_mask = ValueTag::TAG_MASK,
            object_tag = ValueTag::OBJECT,
            undefined = ValueTag::UNDEFINED,
    ...
    (local.set $epoch_ms
      (i32.shr_s
        (i32.load
          (i32.add (i32.and (local.get $date) (i32.const {heap_mask})) (i32.const {epoch_offset})))
        (i32.const {number_shift})))
    (call $host_date_set_year (local.get $epoch_ms) (local.get $year)))
"#,
            tag_mask = ValueTag::TAG_MASK,
            object_tag = ValueTag::OBJECT,
            undefined = ValueTag::UNDEFINED,
    ...
    (local.set $epoch_ms
      (i32.shr_s
        (i32.load
          (i32.add (i32.and (local.get $date) (i32.const {heap_mask})) (i32.const {epoch_offset})))
        (i32.const {number_shift})))
    (call $host_date_to_gmt_string (local.get $epoch_ms)))
"#,
            tag_mask = ValueTag::TAG_MASK,
            object_tag = ValueTag::OBJECT,
            undefined = ValueTag::UNDEFINED,
