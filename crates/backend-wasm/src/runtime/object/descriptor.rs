...
impl WatEmitter<'_> {
    ...
    (block $desc_done (result i32)
      ...
      (loop $desc_loop
        ...
        (if (i32.eq (local.get $key_len) (i32.const -1))
          (then
            (if (i32.eq (local.get $entry_key_raw) (local.get $key_arg))
              (then
        ...
        (if
          (i32.and
            (i32.eq (i32.and (local.get $entry_key_raw) (i32.const {tag_mask})) (i32.const {object_tag}))
            (i32.eq
  ...
  (func $object_define_property (param $obj i32) (param $key i32) (param $desc i32) (result i32)
    ...
    (if (i32.ne (local.get $value) (i32.const {undefined}))
      (then (drop (call $property_set (local.get $obj) (local.get $key_arg) (local.get $key_len) (local.get $value)))))
