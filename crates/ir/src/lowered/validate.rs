...
fn validate_stmt(
    ...
    match stmt {
        ...
        LoweredStmt::ClassDecl { .. } => {
            // This variant is never generated by the lowered resolver; ResolvedStmt::ClassDecl
            // is converted to LoweredStmt::Expr(LoweredExpr::Undefined) at resolver.rs:671.
            // The variant exists as a placeholder for future full class runtime support.
            // If this assertion fires, the lowered resolver contract has changed.
        }
    }
}
