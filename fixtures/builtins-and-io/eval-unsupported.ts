// eval with string literal — parser can extract this statically
...
// indirect eval via member expression — parser rejects (indirect_eval_call_diagnostic)
// console.log(window.eval("1+1"));

// indirect eval via comma expression — parser rejects
