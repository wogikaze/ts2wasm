# Assignment: issue 060 coverage ramp2500
...
Continue the reference-backed test262 coverage ramp after parent merged limit 2000.
Preferred next slice is limit 2500 with `--detail`, classification of any new
...
Save a cycle report under `reports/runs/<timestamp>-060-coverage-ramp2500/`.
