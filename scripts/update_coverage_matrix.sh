...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| test262 | 0 | 0 | 0.00 | 0.00 | 0 | 0 | 0 | 0 | 0 | 0 | - | in-progress | `scripts/reference_coverage.sh test262 --limit 0` |
| TypeScript compiler cases | 0 | 0 | 0.00 | 0.00 | 0 | 0 | 0 | 0 | 0 | 0 | - | in-progress | `scripts/reference_coverage.sh tsc --limit 0` |
| typescript-go testdata | 0 | 0 | 0.00 | 0.00 | 0 | 0 | 0 | 0 | 0 | 0 | - | in-progress | `scripts/reference_coverage.sh tsgo --limit 0` |
<!-- coverage-table:end -->
EOF
fi
...
run_suite() {
  ...
  printf '| %s | %s | %s | %s | %s | %s | %s | %s | %s | %s | %s | %s | in-progress | `scripts/reference_coverage.sh %s --limit %s` |\n' \
