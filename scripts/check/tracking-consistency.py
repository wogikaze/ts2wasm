...
ISSUE_REF_ALLOWLIST: list[tuple[str, int, str]] = [
    ...
    ("node_diff_fixture_tests.rs", 370, "BigInt triage: mixed Number/BigInt test fixture"),
    ("node_diff_fixture_tests.rs", 373, "BigInt triage: ToPrimitive toString boundary test"),
    ("node_diff_fixture_tests.rs", 374, "BigInt triage: ToPrimitive mixed comparison test"),
