...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:483 open:410 done:73
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 483 | 410 | 73 |
