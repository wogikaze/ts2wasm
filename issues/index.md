...
5001 (Meta: TypeScript Compiler Semantic Analysis Coverage) [done/done] ch:549 open:274 done:275
5004 (Meta: Runtime Builtins Coverage (test262) (audit reopened #5004)) [done/done] ch:24 open:3 done:21
5005 (Meta: TypeScript Compiler Name Resolution Coverage) [done/done] ch:388 open:318 done:70
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 428 | 319 | 109 |
| 2 | 5001 | Meta: TypeScript Compiler Semantic Analysis Coverage | done | done | frontend/semantics | P1 | - | 549 | 274 | 275 |
| 3 | 5004 | Meta: Runtime Builtins Coverage (test262) (audit reopened #5004) | done | done | runtime/builtins | P1 | - | 24 | 3 | 21 |
| 4 | 5005 | Meta: TypeScript Compiler Name Resolution Coverage | done | done | frontend/resolver | P1 | - | 388 | 318 | 70 |
...
| 5311 | Parse property-access += assignments | feature | frontend/syntax | implementation-ready | P1 |  | `M.x += 2` in `constDeclarations-access3.ts` and |
...
| 3598 | Implement Nonnullmappedtype | spike | frontend/syntax | see `issues/done/3598-implement-nonNullMappedType.md` |
| 3599 | Implement Nonnullparameterextendingstringassignabletostring | spike | frontend/syntax | see `issues/done/3599-implement-nonNullParameterExtendingStringAssignableToString.md` |
| 3600 | Implement Nonnullreferencematching | spike | frontend/syntax | see `issues/done/3600-implement-nonNullReferenceMatching.md` |
