...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:454 open:376 done:78
...
5005 (Meta: TypeScript Compiler Name Resolution Coverage) [done/done] ch:411 open:357 done:54
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 454 | 376 | 78 |
