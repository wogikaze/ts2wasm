...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:431 open:322 done:109
...
5005 (Meta: TypeScript Compiler Name Resolution Coverage) [done/done] ch:390 open:320 done:70
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 431 | 322 | 109 |
