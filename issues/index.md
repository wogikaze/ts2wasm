...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:480 open:407 done:73
...
5005 (Meta: TypeScript Compiler Name Resolution Coverage) [done/done] ch:420 open:368 done:52
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 480 | 407 | 73 |
