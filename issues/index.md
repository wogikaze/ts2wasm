...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:446 open:348 done:98
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 446 | 348 | 98 |
...
| 5 | 5002 | Meta: TypeScript Compiler Type System Coverage | done | done | frontend/semantics | P1 | 5000, 5005 | 223 | 202 | 21 |
