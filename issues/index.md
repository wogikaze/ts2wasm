...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:460 open:385 done:75
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 460 | 385 | 75 |
