...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:451 open:368 done:83
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 451 | 368 | 83 |
