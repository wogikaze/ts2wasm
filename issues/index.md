...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:457 open:382 done:75
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 457 | 382 | 75 |
