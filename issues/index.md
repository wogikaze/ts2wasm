...
```
5000 (Meta: TypeScript Compiler Parser Syntax Coverage) [done/design] ch:446 open:345 done:101
...
|-----:|---:|------|-------|-------|------|--------:|-----------:|----------------:|--------------:|--------------:|
| 1 | 5000 | Meta: TypeScript Compiler Parser Syntax Coverage | done | design | frontend/syntax | P1 | - | 446 | 345 | 101 |
