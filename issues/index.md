...
| 5135 | Fix builtin arity validation for coercion/math globals | bug | ir | implementation-ready | P1 |  | Builtin arity validation rejects JavaScript global coercion/math calls with optional or missing arguments before runt... |
| 5136 | Fix arity validation for RegExp/String prototype methods | bug | ir | implementation-ready | P1 |  | RegExp and String prototype arity checks reject zero-argument calls that JavaScript treats as calls with `undefined`. |
<!-- generated:ready:end -->
...
| 1101 | Implement Callsignaturesshouldberesolvedbeforespecialization | spike | frontend/syntax | class: triage-needed | Implement Callsignaturesshouldberesolvedbeforespecialization |
...
| 4812 | Implement RegExp literal support (dup) | spike | runtime/builtins | see `issues/done/4812-implement-regexp-literal.md` |
