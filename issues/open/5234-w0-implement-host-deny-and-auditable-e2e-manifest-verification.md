...
- [ ] --host-deny node produces a compile error for Node-host programs
- [ ] --host-deny node passes for standalone programs
- [ ] Manifest verification detects mismatches between manifest and actual wasm imports
- [ ] E2E tests cover both pass and fail cases
