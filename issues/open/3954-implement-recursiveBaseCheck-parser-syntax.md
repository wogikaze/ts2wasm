---
id: 3954
title: "Implement Recursivebasecheck Parser Syntax"
type: spike
...
Triage recursiveBaseCheck-parser-syntax across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `recursiveBaseCheck-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: recursiveBaseCheck-parser-syntax has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/recursiveBaseCheck3.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/recursiveBaseCheck3.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/recursiveBaseCheck3.ts`
- `reference/typescript/tests/cases/compiler/recursiveBaseCheck4.ts`
- `reference/typescript/tests/cases/compiler/recursiveBaseCheck5.ts`
- `reference/typescript/tests/cases/compiler/recursiveBaseCheck6.ts`
