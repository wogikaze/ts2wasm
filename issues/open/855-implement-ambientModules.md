...
- `issues/open/620-implement-ambientModules.md` - Implement Ambientmodules (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/855-implement-ambientModules.md`
