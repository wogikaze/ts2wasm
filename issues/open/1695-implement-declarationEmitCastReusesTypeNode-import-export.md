---
id: 1695
title: "Implement Declarationemitcastreusestypenode Import Export"
type: spike
...
Triage declarationEmitCastReusesTypeNode-import-export across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `declarationEmitCastReusesTypeNode-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: declarationEmitCastReusesTypeNode-import-export has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/declarationEmitCastReusesTypeNode3.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/declarationEmitCastReusesTypeNode3.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/declarationEmitCastReusesTypeNode3.ts`
- `reference/typescript/tests/cases/compiler/declarationEmitCastReusesTypeNode2.ts`
- `reference/typescript/tests/cases/compiler/declarationEmitCastReusesTypeNode4.ts`
- `reference/typescript/tests/cases/compiler/declarationEmitCastReusesTypeNode1.ts`
