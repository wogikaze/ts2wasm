...
> Evidence: `git log --oneline --all --grep=153` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `ambientExternalModuleWithRelativeModuleName.ts` — relative module name
