...
Implement FunctionDeclaration to handle 4 failing test cases in reference tests.
...
FunctionDeclaration is correctly implemented according to JavaScript/TypeScript specifications. Related diagnostics are only emitted for genuinely unsupported cases.
...
- [ ] Implement semantics for FunctionDeclaration
- [ ] Add fixtures for FunctionDeclaration behavior
...
- [ ] FunctionDeclaration passes for basic cases
- [ ] Related diagnostics reduced in reference tests
- [ ] Regression test added for FunctionDeclaration
...
```sh
scripts/run/reference-coverage.sh tsc --limit 8
```
