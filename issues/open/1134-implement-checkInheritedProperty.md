...
Reference test results show 1 cases fail in directory `checkInheritedProperty` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: checkInheritedProperty has 1 reference failures and needs smart-triage evidence before implementation starts.
...
- `issues/open/200-implement-parser-syntax.md` - Implement parser syntax extensions (same feature label, same group key, title overlap)
