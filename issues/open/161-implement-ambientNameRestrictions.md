...
> Evidence: `git log --oneline --all --grep=161` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `ambientNameRestrictions.ts` — ambient name restrictions
