...
Triage object-literal feature across 638 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 638 cases fail with object-literal diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: object-literal feature has 638 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- test262 reference/test262/test/annexB/language/statements/const/dstr/object-pattern-emulates-undefined.js
```

Coverage window:

```sh
mise run reference-coverage -- test262 --path-filter reference/test262/test/annexB/language/statements/const/dstr/object-pattern-emulates-undefined.js --detail
```
...
```sh
mise run reference-coverage -- test262 --limit 1276
mise run reference-coverage -- test262 --path-filter reference/test262/test/annexB/language/statements/const/dstr/object-pattern-emulates-undefined.js --detail
mise run reference-triage -- test262 reference/test262/test/annexB/language/statements/const/dstr/object-pattern-emulates-undefined.js
```
...
- `reference/test262/test/harness/fnGlobalObject.js`
...
- `reference/test262/test/intl402/Collator/default-options-object-prototype.js`
...
- `issues/open/1650-implement-declFileObjectLiteralWithOnlySetter.md` - Implement Declfileobjectliteralwithonlysetter (same feature label, same group key, title overlap)
