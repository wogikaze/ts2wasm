...
Evidence files:
- `issues/open/618-implement-ambientModuleWithClassDeclarationWithExtends.md` before this move
- `issues/open/618-implement-ambientModuleWithClassDeclarationWithExtends.md` after this move
