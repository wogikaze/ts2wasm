...
```text
Parent reclosed from child evidence. `issues/open/393-*` covers multi-limb
addition, `issues/open/394-*` covers subtraction, `issues/open/383-*` covers
multiplication, `issues/open/391-*` covers division, `issues/open/392-*` covers
remainder, and `issues/open/397-*` covers branch-assigned add/sub operands.
```
