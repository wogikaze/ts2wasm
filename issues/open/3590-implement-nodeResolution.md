...
Reference test results show 8 cases fail in directory `nodeResolution` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: nodeResolution has 8 reference failures and needs smart-triage evidence before implementation starts.
