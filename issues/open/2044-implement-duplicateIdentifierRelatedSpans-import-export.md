---
id: 2044
title: "Implement Duplicateidentifierrelatedspans Import Export"
type: spike
...
Triage duplicateIdentifierRelatedSpans-import-export across 3 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 3 cases fail in directory `duplicateIdentifierRelatedSpans-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: duplicateIdentifierRelatedSpans-import-export has 3 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/duplicateIdentifierRelatedSpans6.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/duplicateIdentifierRelatedSpans6.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/duplicateIdentifierRelatedSpans6.ts`
- `reference/typescript/tests/cases/compiler/duplicateIdentifierRelatedSpans7.ts`
- `reference/typescript/tests/cases/compiler/duplicateIdentifierRelatedSpans_moduleAugmentation.ts`
