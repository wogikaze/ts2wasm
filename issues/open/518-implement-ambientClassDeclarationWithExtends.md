...
> Evidence: `git log --oneline --all --grep=518` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `ambientClassDeclarationWithExtends.ts` — ambient class extends
