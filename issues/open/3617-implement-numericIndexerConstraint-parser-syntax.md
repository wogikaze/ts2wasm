---
id: 3617
title: "Implement Numericindexerconstraint Parser Syntax"
type: spike
...
Triage numericIndexerConstraint-parser-syntax across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `numericIndexerConstraint-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: numericIndexerConstraint-parser-syntax has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/numericIndexerConstraint3.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/numericIndexerConstraint3.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/numericIndexerConstraint3.ts`
- `reference/typescript/tests/cases/compiler/numericIndexerConstraint.ts`
- `reference/typescript/tests/cases/compiler/numericIndexerConstraint5.ts`
- `reference/typescript/tests/cases/compiler/numericIndexerConstraint4.ts`
