...
Triage nanEquality across 1 failing reference test cases and split this bucket into implementation-ready child issues.
...
Problem: nanEquality has 1 reference failures and needs smart-triage evidence before implementation starts.
