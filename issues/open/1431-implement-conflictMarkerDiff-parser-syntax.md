...
Reference test results show 1 cases fail in directory `conflictMarkerDiff-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
