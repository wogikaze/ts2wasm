...
[
  {
    "state": "open",
    "path": "issues/open/160-implement-ambientModules.md",
    "title": "Implement Ambientmodules",
  ...
  {
    "state": "open",
    "path": "issues/open/534-implement-ambientModules.md",
    "title": "Implement Ambientmodules",
...
- Implementation commits: verified via `git log --oneline --all --grep=620`
