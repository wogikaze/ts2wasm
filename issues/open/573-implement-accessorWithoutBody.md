---
id: 573
title: "Implement Accessorwithoutbody (audit reopened #573)"
type: spike
...
Evidence files:
- `issues/open/573-implement-accessorWithoutBody.md` before this move
- `issues/open/573-implement-accessorWithoutBody.md` after this move
