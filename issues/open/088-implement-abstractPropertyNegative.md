...
```json
{
  ...
  "message": "expected Semicolon, got Some(Class) at 88..93",
  "span_start": 88,
  "span_end": 93,
  "line": 6,
  "column": 15,
...
```text
error: [UnsupportedSyntax] expected Semicolon, got Some(Class) at 88..93
```
...
Evidence files:
- `issues/open/088-implement-abstractPropertyNegative.md`
