...
- `issues/open/669-implement-arrayConcat.md` - Implement Arrayconcat (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/904-implement-arrayConcat.md`
