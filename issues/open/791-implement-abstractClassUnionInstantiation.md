...
- `issues/done/556-implement-abstractClassUnionInstantiation.md` - Implement Abstractclassunioninstantiation (same reference path, same feature label, same group key, title overlap)
