...
```sh
mise run reference-triage -- test262 reference/test262/test/language/eval-code/direct/arrow-fn-a-following-parameter-is-named-arguments-arrow-func-declare-arguments-assign-incl-def-param-arrow-arguments.js
```

Coverage window:

```sh
mise run reference-coverage -- test262 --path-filter reference/test262/test/language/eval-code/direct/arrow-fn-a-following-parameter-is-named-arguments-arrow-func-declare-arguments-assign-incl-def-param-arrow-arguments.js --detail
```
...
### Smart triage: Triage parser syntax: arrow fn a following parameter is named arguments arrow func declare arguments assign incl def param arrow arguments

- Issue class: `triage-needed`
- Feature label: `parser-syntax`
- Diagnostic: `UnsupportedSyntax` / `parser-or-frontend-unsupported`
- Path: `reference/test262/test/language/eval-code/direct/arrow-fn-a-following-parameter-is-named-arguments-arrow-func-declare-arguments-assign-incl-def-param-arrow-arguments.js`
...
```json
{
  ...
  "lines": 13,
  "extension": ".js",
  "first_code_line": "description: Declare \"arguments\" and assign to it in direct eval code (Declare |arguments| when a following parameter is named |arguments|.)",
  "test262_metadata": {
...
```json
{
  ...
  "message": "expected Semicolon, got Some(Ident(\"assert\")) at 1650..1656",
  "span_start": 1650,
  "span_end": 1656,
  "line": 55,
  "column": 1,
...
```text
52 | 
53 | const oldArguments = globalThis.arguments;
54 | const f = (p = eval("var arguments = 'param'"), q = () => arguments, arguments) => {}
55 | assert.throws(SyntaxError, f);
56 | assert.sameValue(globalThis.arguments, oldArguments, "globalThis.arguments unchanged");
```
...
[
  ...
  },
  {
    ...
    "line": 53,
    "column": 1,
    "initializer": "globalThis.arguments"
  },
  {
    "kind": "binding",
    "name": "f",
    "line": 54,
    "column": 1,
    "initializer": "(p = eval(\"var arguments = 'param'\"), q = () => arguments, arguments) => {}"
  }
]
```
...
```text
error: [UnsupportedSyntax] expected Semicolon, got Some(Ident("assert")) at 1650..1656
```
    ...
    "diagnostics": [
      {
        "code": 6504,
        "category": "Error",
        "message": "File '/tmp/tmpne6h6n6c/test262-triage-node-input.js' is a JavaScript file. Did you mean to enable the 'allowJs' option?\n  The file is in the program because:\n    Root file specified for compilation"
      }
    ],
    "hints": [],
...
- Implementation commits: verified via `git log --oneline --all --grep=424`
