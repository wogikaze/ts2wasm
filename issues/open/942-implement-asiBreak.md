...
- `issues/open/707-implement-asiBreak.md` - Implement Asibreak (same reference path, same feature label, same group key, title overlap)
...
`issues/open/707-implement-asiBreak.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/942-implement-asiBreak.md`
