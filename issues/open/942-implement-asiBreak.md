...
- `issues/done/707-implement-asiBreak.md` - Implement Asibreak (same reference path, same feature label, same group key, title overlap)
...
`issues/done/707-implement-asiBreak.md` に統合されました。
そちらを参照してください。
## Completion evidence
