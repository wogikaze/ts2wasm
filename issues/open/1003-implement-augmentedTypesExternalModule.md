...
- `issues/done/768-implement-augmentedTypesExternalModule.md` - Implement Augmentedtypesexternalmodule (same reference path, same feature label, same group key, title overlap)
...
`issues/done/768-implement-augmentedTypesExternalModule.md` に統合されました。
そちらを参照してください。
## Completion evidence
