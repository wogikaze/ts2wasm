...
Implement APISample to handle 9 failing test cases in reference tests.

## Problem

Reference test results show 9 cases fail in directory `APISample` with diagnostics: equality-operator, parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

## Desired final state

APISample is correctly implemented according to JavaScript/TypeScript specifications. Related diagnostics are only emitted for genuinely unsupported cases.
...
- [ ] Implement semantics for APISample
- [ ] Add fixtures for APISample behavior
...
- [ ] APISample passes for basic cases
- [ ] Related diagnostics reduced in reference tests
- [ ] Regression test added for APISample
...
```sh
scripts/manager reference-coverage tsc --limit 18
```
