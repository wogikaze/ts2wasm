---
id: 2456
title: "Implement Functionoverloads Parser Syntax"
type: spike
...
Triage functionOverloads-parser-syntax across 14 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 14 cases fail in directory `functionOverloads-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: functionOverloads-parser-syntax has 14 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/functionOverloads1.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/functionOverloads1.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/functionOverloads1.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads10.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads18.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads14.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads21.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads17.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads19.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads23.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads3.ts`
- `reference/typescript/tests/cases/compiler/functionOverloads6.ts`
- ... and 4 more files
