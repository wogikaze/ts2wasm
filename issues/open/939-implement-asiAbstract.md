...
- `issues/done/704-implement-asiAbstract.md` - Implement Asiabstract (same reference path, same feature label, same group key, title overlap)
...
`issues/done/704-implement-asiAbstract.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/939-implement-asiAbstract.md`
