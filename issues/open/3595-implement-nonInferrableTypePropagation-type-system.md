...
Reference test results show 2 cases fail in directory `nonInferrableTypePropagation-type-system` with diagnostics: type-system. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: nonInferrableTypePropagation-type-system has 2 reference failures and needs smart-triage evidence before implementation starts.
