---
id: 4570
title: "Implement Typepredicatesoptionalchaining Name Resolution"
type: spike
...
Triage typePredicatesOptionalChaining-name-resolution across 2 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 2 cases fail in directory `typePredicatesOptionalChaining-name-resolution` with diagnostics: name-resolution. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: typePredicatesOptionalChaining-name-resolution has 2 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/typePredicatesOptionalChaining3.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/typePredicatesOptionalChaining3.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/typePredicatesOptionalChaining3.ts`
- `reference/typescript/tests/cases/compiler/typePredicatesOptionalChaining2.ts`
