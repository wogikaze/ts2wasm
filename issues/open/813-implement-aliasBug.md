...
- `issues/done/578-implement-aliasBug.md` - Implement Aliasbug (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/done/813-implement-aliasBug.md`
