...
- `issues/open/774-implement-autoLift.md` - Implement Autolift (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/1009-implement-autoLift.md`
