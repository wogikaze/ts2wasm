...
> Evidence: `git log --oneline --all --grep=078` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `MemberAccessorDeclaration15.ts` — public on setter parameter rejected
