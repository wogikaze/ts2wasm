...
- `issues/open/717-implement-assignToExistingClass.md` - Implement Assigntoexistingclass (same reference path, same feature label, same group key, title overlap)
...
`issues/open/717-implement-assignToExistingClass.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/952-implement-assignToExistingClass.md`
