---
id: 3104
title: "Implement Jsfilemethodoverloads Import Export"
type: spike
...
Triage jsFileMethodOverloads-import-export across 2 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 2 cases fail in directory `jsFileMethodOverloads-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: jsFileMethodOverloads-import-export has 2 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/jsFileMethodOverloads4.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/jsFileMethodOverloads4.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/jsFileMethodOverloads4.ts`
- `reference/typescript/tests/cases/compiler/jsFileMethodOverloads3.ts`
