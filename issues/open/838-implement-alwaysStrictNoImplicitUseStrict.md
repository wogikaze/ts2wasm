...
Evidence files:
- `issues/open/838-implement-alwaysStrictNoImplicitUseStrict.md` before this move
- `issues/open/838-implement-alwaysStrictNoImplicitUseStrict.md` after this move
