...
- [x] folded into: `issues/open/5228-w0-wasm-binary-backend-mvp.md`
...
- Superseded by
  `issues/open/5228-w0-wasm-binary-backend-mvp.md`, which owns
...
- folded into `issues/open/5228-w0-wasm-binary-backend-mvp.md`
