...
Evidence files:
- `issues/open/3385-implement-moduleResolutionWithSuffixes-import-export.md` before this move
- `issues/open/3385-implement-moduleResolutionWithSuffixes-import-export.md` after this move
