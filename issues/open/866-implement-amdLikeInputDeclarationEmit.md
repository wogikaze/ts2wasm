...
- `issues/open/631-implement-amdLikeInputDeclarationEmit.md` - Implement Amdlikeinputdeclarationemit (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/866-implement-amdLikeInputDeclarationEmit.md`
