...
- `issues/done/593-implement-aliasUsedAsNameValue.md` - Implement Aliasusedasnamevalue (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/done/828-implement-aliasUsedAsNameValue.md`
