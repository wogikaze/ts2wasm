...
- `issues/open/593-implement-aliasUsedAsNameValue.md` - Implement Aliasusedasnamevalue (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/828-implement-aliasUsedAsNameValue.md`
