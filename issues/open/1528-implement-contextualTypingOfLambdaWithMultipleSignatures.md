---
id: 1528
title: "Implement Contextualtypingoflambdawithmultiplesignatures"
type: spike
...
> Evidence: Empty completion evidence. No feat/fix commit for #1528.

## Summary

Triage contextualTypingOfLambdaWithMultipleSignatures across 1 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 1 cases fail in directory `contextualTypingOfLambdaWithMultipleSignatures` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: contextualTypingOfLambdaWithMultipleSignatures has 1 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/contextualTypingOfLambdaWithMultipleSignatures2.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/contextualTypingOfLambdaWithMultipleSignatures2.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/contextualTypingOfLambdaWithMultipleSignatures2.ts`
