...
- `issues/done/660-implement-argumentsUsedInObjectLiteralProperty.md` - Implement Argumentsusedinobjectliteralproperty (same reference path, same feature label, same group key, title overlap)
...
`issues/done/660-implement-argumentsUsedInObjectLiteralProperty.md` に統合されました。
そちらを参照してください。
## Completion evidence
