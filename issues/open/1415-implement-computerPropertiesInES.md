...
Reference test results show 1 cases fail in directory `computerPropertiesInES` with diagnostics: template-literal. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
