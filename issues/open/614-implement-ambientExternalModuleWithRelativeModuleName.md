---
id: 614
title: "Implement Ambientexternalmodulewithrelativemodulename (audit reopened #614)"
type: spike
...
[
  ...
  {
    "state": "open",
    "path": "issues/open/528-implement-ambientExternalModuleWithRelativeModuleName.md",
    "title": "Implement Ambientexternalmodulewithrelativemodulename",
...
Evidence files:
- `issues/open/614-implement-ambientExternalModuleWithRelativeModuleName.md` before this move
- `issues/open/614-implement-ambientExternalModuleWithRelativeModuleName.md` after this move
