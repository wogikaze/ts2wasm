...
> Evidence: `git log --oneline --all --grep=5024` shows only re-open and chore close commits — no feat/fix commit.
> Required to close: Implementation commit that fixes anonterface.ts `new` expression with non-identifier class reference.
