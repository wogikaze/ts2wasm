...
Evidence files:
- `issues/open/221-implement-gc-call-frame-roots-for-closure-escape.md` before this move
- `issues/open/221-implement-gc-call-frame-roots-for-closure-escape.md` after this move
