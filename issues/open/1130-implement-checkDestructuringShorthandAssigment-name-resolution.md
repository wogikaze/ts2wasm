...
Problem: `checkDestructuringShorthandAssigment.ts` is too broad for direct implementation. Its current observable blocker is now tracked by `issues/open/5224-handle-package-json-virtual-sections-in-multifile-references.md`.
...
This generated bucket is superseded by `issues/open/5224-handle-package-json-virtual-sections-in-multifile-references.md`. Do not implement directly from this bucket.
...
- child issue: `issues/open/5224-handle-package-json-virtual-sections-in-multifile-references.md`
