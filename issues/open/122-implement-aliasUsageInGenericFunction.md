---
id: 122
title: "Implement Aliasusageingenericfunction (dup)"
type: spike
...
Reference test results show 1 cases fail in directory `aliasUsageInGenericFunction` with diagnostics: type-alias. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
...
### Smart triage: Triage type alias: aliasUsageInGenericFunction
...
```text
error: [UnsupportedSyntax] issue-055: unsupported class export; module resolution and loading are not implemented at 97..103
```
...
`issues/open/587-implement-aliasUsageInGenericFunction.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/122-implement-aliasUsageInGenericFunction.md`
