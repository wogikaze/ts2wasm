...
- `issues/done/745-implement-assignmentToObjectAndFunction.md` - Implement Assignmenttoobjectandfunction (same reference path, same feature label, same group key, title overlap)
...
`issues/done/745-implement-assignmentToObjectAndFunction.md` に統合されました。
そちらを参照してください。
## Completion evidence
