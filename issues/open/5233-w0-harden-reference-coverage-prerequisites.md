...
- [ ] mise run reference-coverage -- --check-prerequisites validates all prerequisites
- [ ] Clear error message for each missing prerequisite
- [ ] CI runs prerequisite check before actual coverage
- [ ] No regression in normal coverage runs
