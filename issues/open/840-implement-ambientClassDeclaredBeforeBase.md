...
> Evidence: `git log --oneline --all --grep=840` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `ambientClassDeclaredBeforeBase.ts` — ambient class order
