...
Reference test results show 1 cases fail in directory `noIterationTypeErrorsInCFA` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: noIterationTypeErrorsInCFA has 1 reference failures and needs smart-triage evidence before implementation starts.
