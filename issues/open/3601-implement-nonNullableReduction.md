---
id: 3601
title: "Implement Nonnullablereduction"
type: spike
...
Close the generated `nonNullableReduction` bucket as stale. Fresh focused
...
`nonNullableReduction` with diagnostics: parser-syntax. Fresh evidence on
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/nonNullableReduction.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/nonNullableReduction.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/nonNullableReduction.ts`
...
### Smart triage: Build pass: nonNullableReduction

- Issue class: `none`
- Feature label: `build-pass`
- Diagnostic: `BuildPass` / `pass`
- Path: `reference/typescript/tests/cases/compiler/nonNullableReduction.ts`
...
blocked=0
semantic_enabled=0
reference/typescript/tests/cases/compiler/nonNullableReduction.ts: build_pass
```
...
```text
command: env TS2WASM_BINARY=/tmp/ts2wasm-issue-blockers-target/debug/ts2wasm python scripts/manager.py reference-triage tsc reference/typescript/tests/cases/compiler/nonNullableReduction.ts
result: pass; BuildPass / pass with no TypeScript oracle diagnostics
date: 2026-05-08

command: env TS2WASM_BINARY=/tmp/ts2wasm-issue-blockers-target/debug/ts2wasm python scripts/manager.py reference-coverage tsc --path-filter reference/typescript/tests/cases/compiler/nonNullableReduction.ts --detail --no-dashboard-data
