...
- `issues/done/739-implement-assignmentStricterConstraints.md` - Implement Assignmentstricterconstraints (same reference path, same feature label, same group key, title overlap)
...
`issues/done/739-implement-assignmentStricterConstraints.md` に統合されました。
そちらを参照してください。
## Completion evidence
