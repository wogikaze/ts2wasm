...
- `issues/done/599-implement-allowJscheckJsTypeParameterNoCrash.md` - Implement Allowjscheckjstypeparameternocrash (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/done/834-implement-allowJscheckJsTypeParameterNoCrash.md`
