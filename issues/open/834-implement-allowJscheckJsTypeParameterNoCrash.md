---
id: 834
title: "Implement Allowjscheckjstypeparameternocrash (dup)"
type: spike
...
- `issues/open/599-implement-allowJscheckJsTypeParameterNoCrash.md` - Implement Allowjscheckjstypeparameternocrash (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/834-implement-allowJscheckJsTypeParameterNoCrash.md`
