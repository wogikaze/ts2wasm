---
id: 487
title: "Implement Accessorwithoutbody (audit reopened #487)"
type: spike
...
Evidence files:
- `issues/open/487-implement-accessorWithoutBody.md` before this move
- `issues/open/487-implement-accessorWithoutBody.md` after this move
