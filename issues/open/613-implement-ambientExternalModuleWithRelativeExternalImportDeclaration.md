---
id: 613
title: "Implement Ambientexternalmodulewithrelativeexternalimportdeclaration (audit reopened #613)"
type: spike
...
[
  ...
  {
    "state": "open",
    "path": "issues/open/527-implement-ambientExternalModuleWithRelativeExternalImportDeclaration.md",
    "title": "Implement Ambientexternalmodulewithrelativeexternalimportdeclaration",
...
Evidence files:
- `issues/open/613-implement-ambientExternalModuleWithRelativeExternalImportDeclaration.md` before this move
- `issues/open/613-implement-ambientExternalModuleWithRelativeExternalImportDeclaration.md` after this move
