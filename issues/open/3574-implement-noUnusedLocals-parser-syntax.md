...
Reference test results show 3 cases fail in directory `noUnusedLocals-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: noUnusedLocals-parser-syntax has 3 reference failures and needs smart-triage evidence before implementation starts.
