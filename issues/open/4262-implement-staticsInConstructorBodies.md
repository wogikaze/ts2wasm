...
Reference test results show 1 cases fail in directory `staticsInConstructorBodies` with diagnostics: unknown-unsupported. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: staticsInConstructorBodies has 1 reference failures and needs smart-triage evidence before implementation starts.
