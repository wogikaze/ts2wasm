---
id: 2781
title: "Implement Indexer Parser Syntax"
type: spike
...
Triage indexer-parser-syntax across 3 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 3 cases fail in directory `indexer-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: indexer-parser-syntax has 3 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/indexer.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/indexer.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/indexer.ts`
- `reference/typescript/tests/cases/compiler/indexer3.ts`
- `reference/typescript/tests/cases/compiler/indexer2A.ts`
