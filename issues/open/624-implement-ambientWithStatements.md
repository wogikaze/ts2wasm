...
[
  ...
  {
    "state": "open",
    "path": "issues/open/538-implement-ambientWithStatements.md",
    "title": "Implement Ambientwithstatements",
...
Evidence files:
- `issues/open/624-implement-ambientWithStatements.md` before this move
- `issues/open/624-implement-ambientWithStatements.md` after this move
