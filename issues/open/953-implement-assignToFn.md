---
id: 953
title: "Implement Assigntofn (dup)"
type: spike
...
- `issues/open/718-implement-assignToFn.md` - Implement Assigntofn (same reference path, same feature label, same group key, title overlap)
...
`issues/open/718-implement-assignToFn.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/953-implement-assignToFn.md`
