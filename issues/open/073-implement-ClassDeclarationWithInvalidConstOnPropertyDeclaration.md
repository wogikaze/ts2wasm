...
> Evidence: `git log --oneline --all --grep=073` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `ClassDeclarationWithInvalidConstOnPropertyDeclaration.ts` — const on property declarations
...
[
  ...
  {
    "state": "open",
    "path": "issues/open/073-implement-ClassDeclarationWithInvalidConstOnPropertyDeclaration.md",
    "title": "Implement Classdeclarationwithinvalidconstonpropertydeclaration",
