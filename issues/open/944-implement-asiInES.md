...
- `issues/done/709-implement-asiInES.md` - Implement Asiines (same reference path, same feature label, same group key, title overlap)
...
`issues/done/709-implement-asiInES.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/944-implement-asiInES.md`
