---
id: 925
title: "Implement Arrayreferencewithouttypeargs (dup)"
type: spike
...
- `issues/open/690-implement-arrayReferenceWithoutTypeArgs.md` - Implement Arrayreferencewithouttypeargs (same reference path, same feature label, same group key, title overlap)
...
`issues/open/690-implement-arrayReferenceWithoutTypeArgs.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/925-implement-arrayReferenceWithoutTypeArgs.md`
