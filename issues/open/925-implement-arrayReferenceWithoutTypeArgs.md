...
- `issues/done/690-implement-arrayReferenceWithoutTypeArgs.md` - Implement Arrayreferencewithouttypeargs (same reference path, same feature label, same group key, title overlap)
...
`issues/done/690-implement-arrayReferenceWithoutTypeArgs.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/925-implement-arrayReferenceWithoutTypeArgs.md`
