...
- `issues/done/682-implement-arrayIndexWithArrayFails.md` - Implement Arrayindexwitharrayfails (same reference path, same feature label, same group key, title overlap)
...
`issues/done/682-implement-arrayIndexWithArrayFails.md` に統合されました。
そちらを参照してください。
## Completion evidence
