...
- [ ] 全 Expr variant に fixture が存在する
- [ ] 不足 variant が可視化される
...
Evidence files:
- `issues/open/5041-frontend-expr-fixture-coverage.md` before this move
- `issues/open/5041-frontend-expr-fixture-coverage.md` after this move
