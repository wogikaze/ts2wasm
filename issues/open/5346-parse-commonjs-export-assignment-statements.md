...
- Virtual `@Filename` section import resolution, tracked by `issues/open/5229a-resolve-imports-between-filename-sections.md`.
...
- Implementation commits: verified via `git log --oneline --all --grep=5346`
