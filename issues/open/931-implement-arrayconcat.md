...
- `issues/open/696-implement-arrayconcat.md` - Implement Arrayconcat (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/931-implement-arrayconcat.md`
