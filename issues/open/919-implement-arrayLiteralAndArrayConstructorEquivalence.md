...
- `issues/done/684-implement-arrayLiteralAndArrayConstructorEquivalence.md` - Implement Arrayliteralandarrayconstructorequivalence (same reference path, same feature label, same group key, title overlap)
...
`issues/done/684-implement-arrayLiteralAndArrayConstructorEquivalence.md` に統合されました。
そちらを参照してください。
## Completion evidence
