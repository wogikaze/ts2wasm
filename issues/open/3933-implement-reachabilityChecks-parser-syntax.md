---
id: 3933
title: "Implement Reachabilitychecks Parser Syntax"
type: spike
...
Triage reachabilityChecks-parser-syntax across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `reachabilityChecks-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: reachabilityChecks-parser-syntax has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/reachabilityChecks10.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/reachabilityChecks10.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/reachabilityChecks10.ts`
- `reference/typescript/tests/cases/compiler/reachabilityChecks1.ts`
- `reference/typescript/tests/cases/compiler/reachabilityChecks6.ts`
- `reference/typescript/tests/cases/compiler/reachabilityChecks5.ts`
