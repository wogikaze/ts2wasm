...
- `issues/done/686-implement-arrayLiteralContextualType.md` - Implement Arrayliteralcontextualtype (same reference path, same feature label, same group key, title overlap)
...
`issues/done/686-implement-arrayLiteralContextualType.md` に統合されました。
そちらを参照してください。
## Completion evidence
