...
Issue 033 completed basic matching/default behavior but recorded that every case currently breaks automatically. This differs from ECMAScript semantics and must be tracked separately from basic switch support.
