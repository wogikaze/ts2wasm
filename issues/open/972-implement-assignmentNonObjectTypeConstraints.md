...
- `issues/done/737-implement-assignmentNonObjectTypeConstraints.md` - Implement Assignmentnonobjecttypeconstraints (same reference path, same feature label, same group key, title overlap)
...
`issues/done/737-implement-assignmentNonObjectTypeConstraints.md` に統合されました。
そちらを参照してください。
## Completion evidence
