---
id: 5069
title: "Implement class-accessor support (dup)"
type: spike
...
Triage class-accessor feature across 94 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 94 cases fail with class-accessor diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: class-accessor feature has 94 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-coverage -- test262 --limit 188
mise run reference-coverage -- test262 --path-filter reference/test262/test/harness/verifyProperty-restore-accessor-symbol.js --detail
mise run reference-triage -- test262 reference/test262/test/harness/verifyProperty-restore-accessor-symbol.js
```
