# Implement GC sweep reuse and fixtures (audit reopened #219)
...
- [ ] Long-running transient GC fixture avoids OOM/leak behavior.
- [ ] Node differential tests pass for GC-relevant fixture.
...
Evidence files:
- `issues/open/219-implement-gc-sweep-reuse-and-fixtures.md` before this move
- `issues/open/219-implement-gc-sweep-reuse-and-fixtures.md` after this move
