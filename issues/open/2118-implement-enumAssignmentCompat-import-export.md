---
id: 2118
title: "Implement Enumassignmentcompat Import Export"
type: spike
...
Triage enumAssignmentCompat-import-export across 5 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 5 cases fail in directory `enumAssignmentCompat-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: enumAssignmentCompat-import-export has 5 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/enumAssignmentCompat.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/enumAssignmentCompat.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/enumAssignmentCompat.ts`
- `reference/typescript/tests/cases/compiler/enumAssignmentCompat3.ts`
- `reference/typescript/tests/cases/compiler/enumAssignmentCompat4.ts`
- `reference/typescript/tests/cases/compiler/enumAssignmentCompat7.ts`
- `reference/typescript/tests/cases/compiler/enumAssignmentCompat6.ts`
