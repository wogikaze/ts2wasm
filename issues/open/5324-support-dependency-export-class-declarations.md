...
- Entry-module export class declarations, tracked by `issues/open/5232-support-entry-export-class-declarations.md`.
...
- `issues/open/5232-support-entry-export-class-declarations.md` covers entry-module `export class`, not dependency virtual files.
...
Also owns `issues/done/3356-implement-moduleNoneErrors.md`: fresh triage for
