---
id: 848
title: "Implement Ambientexternalmodulewithrelativeexternalimportdeclaration (audit reopened #848)"
type: spike
...
Evidence files:
- `issues/open/848-implement-ambientExternalModuleWithRelativeExternalImportDeclaration.md` before this move
