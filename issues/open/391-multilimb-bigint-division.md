...
- [ ] Implement canonical truncating division for dynamic BigInt operands and results.
- [ ] Preserve canonical zero and sign behavior for division.
...
- [ ] Node/iwasm differential fixtures cover dynamic BigInt div with operands or results outside signed i64.
...
```sh
cargo fmt --all --check
cargo test -p ts2wasm-cli --test m2_node_diff bigint_large_div
