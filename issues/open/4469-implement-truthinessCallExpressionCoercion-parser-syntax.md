---
id: 4469
title: "Implement Truthinesscallexpressioncoercion Parser Syntax"
type: spike
...
Triage truthinessCallExpressionCoercion-parser-syntax across 3 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 3 cases fail in directory `truthinessCallExpressionCoercion-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: truthinessCallExpressionCoercion-parser-syntax has 3 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/truthinessCallExpressionCoercion.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/truthinessCallExpressionCoercion.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/truthinessCallExpressionCoercion.ts`
- `reference/typescript/tests/cases/compiler/truthinessCallExpressionCoercion2.ts`
- `reference/typescript/tests/cases/compiler/truthinessCallExpressionCoercion1.ts`
