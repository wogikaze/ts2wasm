---
id: 2901
title: "Implement Interfacedeclaration Import Export"
type: spike
...
Triage interfaceDeclaration-import-export across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `interfaceDeclaration-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: interfaceDeclaration-import-export has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/interfaceDeclaration5.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/interfaceDeclaration5.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/interfaceDeclaration5.ts`
- `reference/typescript/tests/cases/compiler/interfaceDeclaration3.ts`
- `reference/typescript/tests/cases/compiler/interfaceDeclaration2.ts`
- `reference/typescript/tests/cases/compiler/interfaceDeclaration4.ts`
