...
Triage namespaces across 2 failing reference test cases and split this bucket into implementation-ready child issues.
...
Problem: namespaces has 2 reference failures and needs smart-triage evidence before implementation starts.
...
- `issues/done/713-implement-assertionFunctionWildcardImport.md` - Implement Assertionfunctionwildcardimport (same feature label, same group key, title overlap)
