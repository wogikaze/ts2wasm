...
### Smart triage: Triage parser syntax: accessInstanceMemberFromStaticMethod01
...
```json
{
  ...
  "message": "expected LeftParen, got Some(Colon) at 45..46",
  "span_start": 45,
  "span_end": 46,
  "line": 3,
  "column": 17,
...
```text
error: [UnsupportedSyntax] expected LeftParen, got Some(Colon) at 45..46
```
...
Evidence files:
- `issues/open/091-implement-accessInstanceMemberFromStaticMethod.md`
