---
id: 1742
title: "Implement Declarationemitexpressioninextends Import Export"
type: spike
...
Triage declarationEmitExpressionInExtends-import-export across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `declarationEmitExpressionInExtends-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: declarationEmitExpressionInExtends-import-export has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/declarationEmitExpressionInExtends3.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/declarationEmitExpressionInExtends3.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/declarationEmitExpressionInExtends3.ts`
- `reference/typescript/tests/cases/compiler/declarationEmitExpressionInExtends5.ts`
- `reference/typescript/tests/cases/compiler/declarationEmitExpressionInExtends7.ts`
- `reference/typescript/tests/cases/compiler/declarationEmitExpressionInExtends6.ts`
