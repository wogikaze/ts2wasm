...
- `issues/open/721-implement-assignToObjectTypeWithPrototypeProperty.md` - Implement Assigntoobjecttypewithprototypeproperty (same reference path, same feature label, same group key, title overlap)
...
`issues/open/721-implement-assignToObjectTypeWithPrototypeProperty.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/956-implement-assignToObjectTypeWithPrototypeProperty.md`
