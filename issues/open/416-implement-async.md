...
- `issues/open/062g-heap-closure-object-abi-and-rooting.md` - Define and implement heap closure object ABI and rooting (same feature label, same group key, title overlap)
