...
> Evidence: `git log --oneline --all --grep=572` shows only creation/chore commits — no feat/fix commit.
...
[
  ...
  {
    "state": "open",
    "path": "issues/open/486-implement-accessorWithLineTerminator.md",
    "title": "Implement Accessorwithlineterminator",
