...
- `issues/done/1186-implement-classExpressionWithDecorator.md` - Implement Classexpressionwithdecorator (same feature label, same group key, title overlap; split to issue 5253)
