...
- [ ] Heap values live in top-level user locals are marked across collection.
- [ ] Object escape GC fixture triggers collection and preserves semantics.
- [ ] Node differential tests pass for object escape GC fixture.
...
Evidence files:
- `issues/open/220-implement-gc-top-level-local-roots-for-object-escape-fixtures.md` before this move
- `issues/open/220-implement-gc-top-level-local-roots-for-object-escape-fixtures.md` after this move
