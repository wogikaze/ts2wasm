...
- `issues/done/705-implement-asiAmbientFunctionDeclaration.md` - Implement Asiambientfunctiondeclaration (same reference path, same feature label, same group key, title overlap)
...
`issues/done/705-implement-asiAmbientFunctionDeclaration.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/940-implement-asiAmbientFunctionDeclaration.md`
