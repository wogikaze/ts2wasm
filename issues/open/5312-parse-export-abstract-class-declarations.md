...
- `issues/open/5232-w0-fixture-ize-runtimelinkplan-linker-structure-tests.md` starts after
...
- Implementation commits: verified via `git log --oneline --all --grep=5312`
