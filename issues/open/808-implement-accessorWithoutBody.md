---
id: 808
title: "Implement Accessorwithoutbody (audit reopened #808)"
type: spike
...
- `issues/open/573-implement-accessorWithoutBody.md` - Implement Accessorwithoutbody (same reference path, same feature label, same group key, title overlap)
...
Superseded by issue #105. Duplicate from separate coverage run.
...
Evidence files:
- `issues/open/808-implement-accessorWithoutBody.md` before this move
- `issues/open/808-implement-accessorWithoutBody.md` after this move
