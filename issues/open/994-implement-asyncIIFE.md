...
- `issues/done/759-implement-asyncIIFE.md` - Implement Asynciife (same reference path, same feature label, same group key, title overlap)
...
`issues/done/759-implement-asyncIIFE.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/994-implement-asyncIIFE.md`
