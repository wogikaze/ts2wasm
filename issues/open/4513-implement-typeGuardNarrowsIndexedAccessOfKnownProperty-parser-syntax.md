---
id: 4513
title: "Implement Typeguardnarrowsindexedaccessofknownproperty Parser Syntax"
type: spike
...
Triage typeGuardNarrowsIndexedAccessOfKnownProperty-parser-syntax across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `typeGuardNarrowsIndexedAccessOfKnownProperty-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: typeGuardNarrowsIndexedAccessOfKnownProperty-parser-syntax has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/typeGuardNarrowsIndexedAccessOfKnownProperty11.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/typeGuardNarrowsIndexedAccessOfKnownProperty11.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/typeGuardNarrowsIndexedAccessOfKnownProperty11.ts`
- `reference/typescript/tests/cases/compiler/typeGuardNarrowsIndexedAccessOfKnownProperty2.ts`
- `reference/typescript/tests/cases/compiler/typeGuardNarrowsIndexedAccessOfKnownProperty12.ts`
- `reference/typescript/tests/cases/compiler/typeGuardNarrowsIndexedAccessOfKnownProperty9.ts`
