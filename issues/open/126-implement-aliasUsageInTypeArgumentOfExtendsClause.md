---
id: 126
title: "Implement Aliasusageintypeargumentofextendsclause (dup)"
type: spike
...
Reference test results show 1 cases fail in directory `aliasUsageInTypeArgumentOfExtendsClause` with diagnostics: type-alias. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
...
### Smart triage: Triage type alias: aliasUsageInTypeArgumentOfExtendsClause
...
```text
error: [UnsupportedSyntax] issue-055: unsupported class export; module resolution and loading are not implemented at 109..115
```
...
Evidence files:
- `issues/open/126-implement-aliasUsageInTypeArgumentOfExtendsClause.md`
