...
- `issues/done/748-implement-asyncArrowInClassES.md` - Implement Asyncarrowinclasses (same reference path, same feature label, same group key, title overlap)
...
`issues/done/748-implement-asyncArrowInClassES.md` に統合されました。
そちらを参照してください。
## Completion evidence
