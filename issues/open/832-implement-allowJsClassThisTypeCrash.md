...
- `issues/done/132-implement-allowJsClassThisTypeCrash.md` - Implement Allowjsclassthistypecrash (same reference path, same group key, title overlap)
- `issues/done/511-implement-allowJsClassThisTypeCrash.md` - Implement Allowjsclassthistypecrash (same reference path, same feature label, same group key, title overlap)
- `issues/done/597-implement-allowJsClassThisTypeCrash.md` - Implement Allowjsclassthistypecrash (same reference path, same feature label, same group key, title overlap)
...
`issues/done/597-implement-allowJsClassThisTypeCrash.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/832-implement-allowJsClassThisTypeCrash.md`
