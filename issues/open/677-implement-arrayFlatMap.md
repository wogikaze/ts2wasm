---
id: 677
title: "Implement Arrayflatmap (audit reopened #677)"
type: spike
...
Evidence files:
- `issues/open/677-implement-arrayFlatMap.md` before this move
- `issues/open/677-implement-arrayFlatMap.md` after this move
