...
- `issues/done/531-implement-ambientModuleExports.md` - Implement Ambientmoduleexports (same reference path, same feature label, same group key, title overlap)
- `issues/done/617-implement-ambientModuleExports.md` - Implement Ambientmoduleexports (same reference path, same feature label, same group key, title overlap)
...
`issues/done/617-implement-ambientModuleExports.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/852-implement-ambientModuleExports.md`
