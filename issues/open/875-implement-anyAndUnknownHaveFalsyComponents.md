...
- `issues/open/640-implement-anyAndUnknownHaveFalsyComponents.md` - Implement Anyandunknownhavefalsycomponents (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/875-implement-anyAndUnknownHaveFalsyComponents.md`
