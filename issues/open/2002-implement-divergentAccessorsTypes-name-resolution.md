---
id: 2002
title: "Implement Divergentaccessorstypes Name Resolution"
type: spike
...
Triage divergentAccessorsTypes-name-resolution across 3 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 3 cases fail in directory `divergentAccessorsTypes-name-resolution` with diagnostics: name-resolution. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: divergentAccessorsTypes-name-resolution has 3 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/divergentAccessorsTypes5.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/divergentAccessorsTypes5.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/divergentAccessorsTypes5.ts`
- `reference/typescript/tests/cases/compiler/divergentAccessorsTypes4.ts`
- `reference/typescript/tests/cases/compiler/divergentAccessorsTypes3.ts`
