...
Triage function feature across 6 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 6 cases fail with function diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: function feature has 6 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- test262 reference/test262/test/annexB/built-ins/Function/createdynfn-html-open-comment-body.js
```

Coverage window:

```sh
mise run reference-coverage -- test262 --path-filter reference/test262/test/annexB/built-ins/Function/createdynfn-html-open-comment-body.js --detail
```
...
```sh
mise run reference-coverage -- test262 --limit 12
mise run reference-coverage -- test262 --path-filter reference/test262/test/annexB/built-ins/Function/createdynfn-html-open-comment-body.js --detail
mise run reference-triage -- test262 reference/test262/test/annexB/built-ins/Function/createdynfn-html-open-comment-body.js
```
...
### Smart triage: Triage eval: createdynfn html open comment body

- Issue class: `triage-needed`
- Feature label: `eval`
- Diagnostic: `UnsupportedEval` / `unsupported-feature-boundary`
- Path: `reference/test262/test/annexB/built-ins/Function/createdynfn-html-open-comment-body.js`
...
```json
{
  ...
  "message": "issue-062: dynamic Function constructor is not supported; runtime code evaluation is intentionally not implemented at 1665..1681",
  "span_start": 1665,
  "span_end": 1681,
  "line": 63,
  "column": 2,
...
[
  {
    "state": "open",
    "path": "issues/open/429-implement-eval.md",
    "title": "Implement eval support",
    "reason": "same reference path, same feature label, title overlap"
  },
  {
    "state": "open",
    "path": "issues/open/5014-implement-eval.md",
    "title": "Implement eval support",
...
```text
error: [UnsupportedEval] issue-062: dynamic Function constructor is not supported; runtime code evaluation is intentionally not implemented at 1665..1681
```
    ...
    "diagnostics": [
      {
        "code": 6504,
        "category": "Error",
        "message": "File '/tmp/tmpl1xdb3ii/test262-triage-node-input.js' is a JavaScript file. Did you mean to enable the 'allowJs' option?\n  The file is in the program because:\n    Root file specified for compilation"
      }
    ],
    "hints": [],
