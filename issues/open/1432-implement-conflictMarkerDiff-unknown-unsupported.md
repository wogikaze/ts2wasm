...
Reference test results show 1 cases fail in directory `conflictMarkerDiff-unknown-unsupported` with diagnostics: unknown-unsupported. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
