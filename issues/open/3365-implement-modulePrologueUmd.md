---
id: 3365
title: "Implement Moduleprologueumd"
type: maintenance
...
Reference test results show 1 case failing in directory `modulePrologueUmd`
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/modulePrologueUmd.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/modulePrologueUmd.ts --detail
```
...
- [x] No child issue is needed from 3365 because the current blocker is already implementation-ready in issue 5232
...
```sh
env TS2WASM_BINARY=/tmp/ts2wasm-issue-blockers-target/debug/ts2wasm python scripts/manager.py reference-coverage tsc --path-filter reference/typescript/tests/cases/compiler/modulePrologueUmd.ts --detail --no-dashboard-data
env TS2WASM_BINARY=/tmp/ts2wasm-issue-blockers-target/debug/ts2wasm python scripts/manager.py reference-triage tsc reference/typescript/tests/cases/compiler/modulePrologueUmd.ts
...
- `reference/typescript/tests/cases/compiler/modulePrologueUmd.ts`
...
reference/typescript/tests/cases/compiler/modulePrologueUmd.ts: UnsupportedSyntax: import-export
```
...
```text
command: env TS2WASM_BINARY=/tmp/ts2wasm-issue-blockers-target/debug/ts2wasm python scripts/manager.py reference-coverage tsc --path-filter reference/typescript/tests/cases/compiler/modulePrologueUmd.ts --detail --no-dashboard-data
result: pass; executed=1, unsupported=1, UnsupportedSyntax/import-export
date: 2026-05-08

command: env TS2WASM_BINARY=/tmp/ts2wasm-issue-blockers-target/debug/ts2wasm python scripts/manager.py reference-triage tsc reference/typescript/tests/cases/compiler/modulePrologueUmd.ts
...
- After issue 5232 lands, this reference may expose UMD module prologue emit
  parity, strict prologue preservation, or UMD module diagnostics.
