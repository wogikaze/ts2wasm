...
Implement amdModuleName to handle 2 failing test cases in reference tests.
...
amdModuleName is correctly implemented according to JavaScript/TypeScript specifications. Related diagnostics are only emitted for genuinely unsupported cases.
...
- [ ] Implement semantics for amdModuleName
- [ ] Add fixtures for amdModuleName behavior
...
- [ ] amdModuleName passes for basic cases
- [ ] Related diagnostics reduced in reference tests
- [ ] Regression test added for amdModuleName
