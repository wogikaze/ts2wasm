...
- `issues/open/635-implement-anonClassDeclarationEmitIsAnon.md` - Implement Anonclassdeclarationemitisanon (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/870-implement-anonClassDeclarationEmitIsAnon.md`
