---
id: 859
title: "Implement Ambientwithstatements (audit reopened #859)"
type: spike
...
- `issues/open/538-implement-ambientWithStatements.md` - Implement Ambientwithstatements (same reference path, same feature label, same group key, title overlap)
- `issues/open/624-implement-ambientWithStatements.md` - Implement Ambientwithstatements (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/859-implement-ambientWithStatements.md` before this move
- `issues/open/859-implement-ambientWithStatements.md` after this move
