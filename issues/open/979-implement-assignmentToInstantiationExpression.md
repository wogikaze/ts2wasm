---
id: 979
title: "Implement Assignmenttoinstantiationexpression (dup)"
type: spike
...
- `issues/done/744-implement-assignmentToInstantiationExpression.md` - Implement Assignmenttoinstantiationexpression (same reference path, same feature label, same group key, title overlap)
...
`issues/done/744-implement-assignmentToInstantiationExpression.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/979-implement-assignmentToInstantiationExpression.md`
