...
- `issues/open/744-implement-assignmentToInstantiationExpression.md` - Implement Assignmenttoinstantiationexpression (same reference path, same feature label, same group key, title overlap)
...
`issues/open/744-implement-assignmentToInstantiationExpression.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/979-implement-assignmentToInstantiationExpression.md`
