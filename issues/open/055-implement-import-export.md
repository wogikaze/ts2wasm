...
Issue 055 is a coordination umbrella. The implementation was split into issues 231, 232, 233, and 234, and all split issue files now live under `issues/open/` with completed frontmatter and completion evidence:
