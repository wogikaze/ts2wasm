...
Reference test results show 1 cases fail in directory `computedPropertyBindingElementDeclarationNoCrash` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
