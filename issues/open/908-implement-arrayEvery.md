...
- `issues/done/673-implement-arrayEvery.md` - Implement Arrayevery (same reference path, same feature label, same group key, title overlap)
...
`issues/done/673-implement-arrayEvery.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/908-implement-arrayEvery.md`
