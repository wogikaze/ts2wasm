---
id: 2484
title: "Implement Generatores Parser Syntax"
type: spike
...
Triage generatorES-parser-syntax across 4 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 4 cases fail in directory `generatorES-parser-syntax` with diagnostics: parser-syntax. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: generatorES-parser-syntax has 4 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/generatorES6_3.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/generatorES6_3.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/generatorES6_3.ts`
- `reference/typescript/tests/cases/compiler/generatorES6_2.ts`
- `reference/typescript/tests/cases/compiler/generatorES6_6.ts`
- `reference/typescript/tests/cases/compiler/generatorES6_4.ts`
