...
Evidence files:
- `issues/open/607-implement-ambientEnumElementInitializer.md` before this move
- `issues/open/607-implement-ambientEnumElementInitializer.md` after this move
...
Evidence files:
- `issues/open/607-implement-ambientEnumElementInitializer.md` after this correction
