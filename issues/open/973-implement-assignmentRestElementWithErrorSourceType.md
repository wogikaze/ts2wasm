...
- `issues/done/738-implement-assignmentRestElementWithErrorSourceType.md` - Implement Assignmentrestelementwitherrorsourcetype (same reference path, same feature label, same group key, title overlap)
...
`issues/done/738-implement-assignmentRestElementWithErrorSourceType.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/973-implement-assignmentRestElementWithErrorSourceType.md`
