---
id: 973
title: "Implement Assignmentrestelementwitherrorsourcetype (dup)"
type: spike
...
- `issues/open/738-implement-assignmentRestElementWithErrorSourceType.md` - Implement Assignmentrestelementwitherrorsourcetype (same reference path, same feature label, same group key, title overlap)
...
`issues/open/738-implement-assignmentRestElementWithErrorSourceType.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/973-implement-assignmentRestElementWithErrorSourceType.md`
