---
id: 3248
title: "Implement Mergeddeclarations Import Export"
type: spike
...
Triage mergedDeclarations-import-export across 5 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 5 cases fail in directory `mergedDeclarations-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: mergedDeclarations-import-export has 5 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/mergedDeclarations1.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/mergedDeclarations1.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/mergedDeclarations1.ts`
- `reference/typescript/tests/cases/compiler/mergedDeclarations3.ts`
- `reference/typescript/tests/cases/compiler/mergedDeclarations7.ts`
- `reference/typescript/tests/cases/compiler/mergedDeclarations6.ts`
- `reference/typescript/tests/cases/compiler/mergedDeclarations4.ts`
