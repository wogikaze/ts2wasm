---
id: 602
title: "Implement Alwaysstrictmodule (audit reopened #602)"
type: spike
...
Evidence files:
- `issues/open/602-implement-alwaysStrictModule.md` before this move
- `issues/open/602-implement-alwaysStrictModule.md` after this move
