...
Evidence files:
- `issues/open/460-implement-ClassDeclaration.md` before this move
- `issues/open/460-implement-ClassDeclaration.md` after this move
...
Evidence files:
- `issues/open/460-implement-ClassDeclaration.md` after this correction
