---
id: 4154
title: "Implement Sourcemap Import Export"
type: spike
...
Triage sourceMap-import-export across 3 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 3 cases fail in directory `sourceMap-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: sourceMap-import-export has 3 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/sourceMap-Comments.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/sourceMap-Comments.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/sourceMap-Comments.ts`
- `reference/typescript/tests/cases/compiler/sourceMap-FileWithComments.ts`
- `reference/typescript/tests/cases/compiler/sourceMap-StringLiteralWithNewLine.ts`
