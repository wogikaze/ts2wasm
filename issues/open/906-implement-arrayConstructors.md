---
id: 906
title: "Implement Arrayconstructors (dup)"
type: spike
...
- `issues/open/671-implement-arrayConstructors.md` - Implement Arrayconstructors (same reference path, same feature label, same group key, title overlap)
...
`issues/open/671-implement-arrayConstructors.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/906-implement-arrayConstructors.md`
