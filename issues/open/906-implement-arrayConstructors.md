...
- `issues/done/671-implement-arrayConstructors.md` - Implement Arrayconstructors (same reference path, same feature label, same group key, title overlap)
...
`issues/done/671-implement-arrayConstructors.md` に統合されました。
そちらを参照してください。
## Completion evidence
