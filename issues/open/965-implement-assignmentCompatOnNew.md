...
- `issues/done/730-implement-assignmentCompatOnNew.md` - Implement Assignmentcompatonnew (same reference path, same feature label, same group key, title overlap)
...
`issues/done/730-implement-assignmentCompatOnNew.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/965-implement-assignmentCompatOnNew.md`
