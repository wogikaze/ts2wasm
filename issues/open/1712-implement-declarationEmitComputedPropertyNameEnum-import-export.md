---
id: 1712
title: "Implement Declarationemitcomputedpropertynameenum Import Export"
type: spike
...
Triage declarationEmitComputedPropertyNameEnum-import-export across 2 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 2 cases fail in directory `declarationEmitComputedPropertyNameEnum-import-export` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: declarationEmitComputedPropertyNameEnum-import-export has 2 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/declarationEmitComputedPropertyNameEnum1.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/declarationEmitComputedPropertyNameEnum1.ts --detail
```
...
- `reference/typescript/tests/cases/compiler/declarationEmitComputedPropertyNameEnum1.ts`
- `reference/typescript/tests/cases/compiler/declarationEmitComputedPropertyNameEnum3.ts`
