...
Triage modulePreserve across 5 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 5 cases fail in directory `modulePreserve` with diagnostics: import-export. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: modulePreserve has 5 reference failures and needs smart-triage evidence before implementation starts.
