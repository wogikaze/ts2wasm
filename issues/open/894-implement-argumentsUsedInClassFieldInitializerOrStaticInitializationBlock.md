...
- `issues/done/659-implement-argumentsUsedInClassFieldInitializerOrStaticInitializationBlock.md` - Implement Argumentsusedinclassfieldinitializerorstaticinitializationblock (same reference path, same feature label, same group key, title overlap)
...
`issues/done/659-implement-argumentsUsedInClassFieldInitializerOrStaticInitializationBlock.md` に統合されました。
そちらを参照してください。
## Completion evidence
