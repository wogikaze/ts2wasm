...
Reference test results show 1 cases fail in directory `conditionalReturnExpression` with diagnostics: name-resolution. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
