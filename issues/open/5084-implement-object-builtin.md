---
id: 5084
title: "Implement object-builtin support (dup)"
type: spike
...
Triage object-builtin feature across 1382 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 1382 cases fail with object-builtin diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: object-builtin feature has 1382 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-coverage -- test262 --limit 2764
mise run reference-coverage -- test262 --path-filter reference/test262/test/built-ins/Object/S15.2.1.1_A2_T11.js --detail
mise run reference-triage -- test262 reference/test262/test/built-ins/Object/S15.2.1.1_A2_T11.js
```
...
- `reference/test262/test/built-ins/Object/S15.2.2.1_A2_T5.js`
- ... and 1372 more files
...
Evidence files:
- `issues/open/5084-implement-object-builtin.md`
