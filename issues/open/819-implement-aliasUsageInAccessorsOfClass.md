...
- `issues/open/498-implement-aliasUsageInAccessorsOfClass.md` - Implement Aliasusageinaccessorsofclass (same reference path, same feature label, same group key, title overlap)
- `issues/open/584-implement-aliasUsageInAccessorsOfClass.md` - Implement Aliasusageinaccessorsofclass (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/open/819-implement-aliasUsageInAccessorsOfClass.md`
