...
> Evidence: `git log --oneline --all --grep=098` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `accessorDeclarationOrder.ts` — accessor declaration order
