---
id: 1392
title: "Implement Comparablerelationbidirectional"
type: spike
...
> Evidence: Empty completion evidence. No feat/fix commit for #1392.
...
`comparableRelationBidirectional.ts` no longer reports the generated
...
`comparableRelationBidirectional` with diagnostics: parser-syntax. Fresh focused
...
```sh
python scripts/manager.py reference-triage tsc reference/typescript/tests/cases/compiler/comparableRelationBidirectional.ts
```

Coverage window:

```sh
python scripts/manager.py reference-coverage tsc --path-filter reference/typescript/tests/cases/compiler/comparableRelationBidirectional.ts --detail --no-dashboard-data
```

Observed 2026-05-07:

```text
Smart triage: Build pass: comparableRelationBidirectional
...
- `reference/typescript/tests/cases/compiler/comparableRelationBidirectional.ts`
...
- Path: reference/typescript/tests/cases/compiler/comparableRelationBidirectional.ts
```
...
```text
AST: ExportDecl(Function getMockData) with nested object literal return.
Resolved: ok=True; function getMockData returns nested object literal.
```
...
```text
command: python scripts/manager.py reference-triage tsc reference/typescript/tests/cases/compiler/comparableRelationBidirectional.ts
result: pass; BuildPass, no compiler blocker found
date: 2026-05-07

command: python scripts/manager.py reference-coverage tsc --path-filter reference/typescript/tests/cases/compiler/comparableRelationBidirectional.ts --detail --no-dashboard-data
