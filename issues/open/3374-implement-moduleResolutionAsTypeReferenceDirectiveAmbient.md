...
Evidence files:
- `issues/open/3374-implement-moduleResolutionAsTypeReferenceDirectiveAmbient.md` before this move
- `issues/open/3374-implement-moduleResolutionAsTypeReferenceDirectiveAmbient.md` after this move
