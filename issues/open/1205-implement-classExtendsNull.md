...
Triage classExtendsNull across 3 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 3 cases fail in directory `classExtendsNull` with diagnostics: unknown-unsupported. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: classExtendsNull has 3 reference failures and needs smart-triage evidence before implementation starts.
