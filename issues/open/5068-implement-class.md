...
Triage class feature across 6823 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 6823 cases fail with class diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: class feature has 6823 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-coverage -- test262 --limit 13646
mise run reference-coverage -- test262 --path-filter reference/test262/test/annexB/language/statements/class/subclass/superclass-emulates-undefined.js --detail
mise run reference-triage -- test262 reference/test262/test/annexB/language/statements/class/subclass/superclass-emulates-undefined.js
```
...
- `reference/test262/test/language/computed-property-names/class/method/constructor-duplicate-1.js`
- `reference/test262/test/language/computed-property-names/class/method/constructor-can-be-generator.js`
- `reference/test262/test/language/computed-property-names/class/method/constructor-duplicate-2.js`
- ... and 6813 more files
