---
id: 1008
title: "Implement Autoasiforstaticsinclassdeclaration (dup)"
type: spike
...
- `issues/open/773-implement-autoAsiForStaticsInClassDeclaration.md` - Implement Autoasiforstaticsinclassdeclaration (same reference path, same feature label, same group key, title overlap)
...
`issues/open/773-implement-autoAsiForStaticsInClassDeclaration.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/open/1008-implement-autoAsiForStaticsInClassDeclaration.md`
