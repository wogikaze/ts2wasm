---
id: 538
title: "Implement Ambientwithstatements (audit reopened #538)"
type: spike
...
Evidence files:
- `issues/open/538-implement-ambientWithStatements.md` before this move
- `issues/open/538-implement-ambientWithStatements.md` after this move
