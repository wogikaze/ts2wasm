...
- `issues/done/741-implement-assignmentToConditionalBrandedStringTemplateOrMapping.md` - Implement Assignmenttoconditionalbrandedstringtemplateormapping (same reference path, same feature label, same group key, title overlap)
...
`issues/done/741-implement-assignmentToConditionalBrandedStringTemplateOrMapping.md` に統合されました。
そちらを参照してください。
## Completion evidence
