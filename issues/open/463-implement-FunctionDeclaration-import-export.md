...
> Evidence: `git log --oneline --all --grep=463` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `FunctionDeclaration7.ts` — function declaration diagnostics
