---
id: 957
title: "Implement Assigntoprototype (dup)"
type: spike
...
- `issues/open/722-implement-assignToPrototype.md` - Implement Assigntoprototype (same reference path, same feature label, same group key, title overlap)
...
`issues/open/722-implement-assignToPrototype.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/957-implement-assignToPrototype.md`
