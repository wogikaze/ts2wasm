---
id: 974
title: "Implement Assignmentstricterconstraints (dup)"
type: spike
...
- `issues/open/739-implement-assignmentStricterConstraints.md` - Implement Assignmentstricterconstraints (same reference path, same feature label, same group key, title overlap)
...
`issues/open/739-implement-assignmentStricterConstraints.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/974-implement-assignmentStricterConstraints.md`
