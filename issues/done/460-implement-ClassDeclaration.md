...
Superseded by issue #072. Duplicate from separate coverage run.
...
Evidence files:
- `issues/done/460-implement-ClassDeclaration.md` before this move
- `issues/done/460-implement-ClassDeclaration.md` after this move
...
Evidence files:
- `issues/done/460-implement-ClassDeclaration.md` after this correction
