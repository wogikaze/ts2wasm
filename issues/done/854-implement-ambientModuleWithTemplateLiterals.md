...
- `issues/done/619-implement-ambientModuleWithTemplateLiterals.md` - Implement Ambientmodulewithtemplateliterals (same reference path, same feature label, same group key, title overlap)
...
`issues/done/619-implement-ambientModuleWithTemplateLiterals.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/854-implement-ambientModuleWithTemplateLiterals.md`
