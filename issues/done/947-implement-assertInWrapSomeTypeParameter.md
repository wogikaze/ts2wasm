---
id: 947
title: "Implement Assertinwrapsometypeparameter (dup)"
type: spike
...
- `issues/done/712-implement-assertInWrapSomeTypeParameter.md` - Implement Assertinwrapsometypeparameter (same reference path, same feature label, same group key, title overlap)
...
`issues/done/712-implement-assertInWrapSomeTypeParameter.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/947-implement-assertInWrapSomeTypeParameter.md`
