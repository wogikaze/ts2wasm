...
Triage array-builtin feature across 1552 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 1552 cases fail with array-builtin diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: array-builtin feature has 1552 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- test262 reference/test262/test/built-ins/Array/S15.4.1_A1.1_T3.js
```

Coverage window:

```sh
mise run reference-coverage -- test262 --path-filter reference/test262/test/built-ins/Array/S15.4.1_A1.1_T3.js --detail
```
...
```sh
mise run reference-coverage -- test262 --limit 3104
mise run reference-coverage -- test262 --path-filter reference/test262/test/built-ins/Array/S15.4.1_A1.1_T3.js --detail
mise run reference-triage -- test262 reference/test262/test/built-ins/Array/S15.4.1_A1.1_T3.js
```
...
- `reference/test262/test/built-ins/Array/S15.4.5.2_A1_T1.js`
- `reference/test262/test/built-ins/Array/S15.4.2.1_A2.2_T1.js`
- `reference/test262/test/built-ins/Array/S15.4.5.1_A2.1_T1.js`
- ... and 1542 more files
