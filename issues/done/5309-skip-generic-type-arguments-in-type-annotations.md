...
- `issues/open/1467-implement-constraintsThatReferenceOtherContstraints.md`
  ...
  `data: Foo<Object, Object>;`; TypeScript parses it as a
  `PropertyDeclaration` with a `TypeReference`, then reports a later TS2564
...
- Implementation commits: verified via `git log --oneline --all --grep=5309`
