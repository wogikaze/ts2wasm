...
Triage parser-syntax feature across 1347 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 1347 cases fail with parser-syntax diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: parser-syntax feature has 1347 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- test262 reference/test262/test/annexB/language/expressions/assignmenttargettype/callexpression-as-for-in-lhs.js
```

Coverage window:

```sh
mise run reference-coverage -- test262 --path-filter reference/test262/test/annexB/language/expressions/assignmenttargettype/callexpression-as-for-in-lhs.js --detail
```
...
```sh
mise run reference-coverage -- test262 --limit 2694
mise run reference-coverage -- test262 --path-filter reference/test262/test/annexB/language/expressions/assignmenttargettype/callexpression-as-for-in-lhs.js --detail
mise run reference-triage -- test262 reference/test262/test/annexB/language/expressions/assignmenttargettype/callexpression-as-for-in-lhs.js
```
...
- `reference/test262/test/annexB/language/function-code/block-decl-func-block-scoping.js`
- `reference/test262/test/annexB/language/function-code/block-decl-func-existing-block-fn-no-init.js`
- `reference/test262/test/annexB/language/function-code/block-decl-func-existing-block-fn-update.js`
- `reference/test262/test/annexB/language/function-code/block-decl-func-existing-fn-no-init.js`
- `reference/test262/test/annexB/language/function-code/block-decl-func-existing-fn-update.js`
- `reference/test262/test/annexB/language/function-code/block-decl-func-existing-var-no-init.js`
- ... and 1337 more files
...
### Smart triage: Triage parser syntax: callexpression as for in lhs

- Issue class: `triage-needed`
- Feature label: `parser-syntax`
- Diagnostic: `UnsupportedSyntax` / `parser-or-frontend-unsupported`
- Path: `reference/test262/test/annexB/language/expressions/assignmenttargettype/callexpression-as-for-in-lhs.js`
...
```json
{
  ...
  "message": "expected Equal, got Some(LeftParen) at 1803..1804",
  "span_start": 1803,
  "span_end": 1804,
  "line": 70,
  "column": 9,
...
```text
error: [UnsupportedSyntax] expected Equal, got Some(LeftParen) at 1803..1804
```
    ...
    "diagnostics": [
      {
        "code": 6504,
        "category": "Error",
        "message": "File '/tmp/tmptgo81zms/test262-triage-node-input.js' is a JavaScript file. Did you mean to enable the 'allowJs' option?\n  The file is in the program because:\n    Root file specified for compilation"
      }
    ],
    "hints": [],
...
- Implementation commits: verified via `git log --oneline --all --grep=442`
