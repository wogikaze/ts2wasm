...
- `issues/done/558-implement-abstractPropertyInConstructor.md` - Implement Abstractpropertyinconstructor (same reference path, same feature label, same group key, title overlap)
...
`issues/done/558-implement-abstractPropertyInConstructor.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/793-implement-abstractPropertyInConstructor.md`
