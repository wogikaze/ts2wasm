---
id: 987
title: "Implement Asyncfunctionreturnexpressionerrorspans (dup)"
type: spike
...
- `issues/open/752-implement-asyncFunctionReturnExpressionErrorSpans.md` - Implement Asyncfunctionreturnexpressionerrorspans (same reference path, same feature label, same group key, title overlap)
...
`issues/open/752-implement-asyncFunctionReturnExpressionErrorSpans.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/987-implement-asyncFunctionReturnExpressionErrorSpans.md`
