...
- `issues/done/752-implement-asyncFunctionReturnExpressionErrorSpans.md` - Implement Asyncfunctionreturnexpressionerrorspans (same reference path, same feature label, same group key, title overlap)
...
`issues/done/752-implement-asyncFunctionReturnExpressionErrorSpans.md` に統合されました。
そちらを参照してください。
## Completion evidence
