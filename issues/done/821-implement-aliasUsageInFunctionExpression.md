...
- `issues/open/586-implement-aliasUsageInFunctionExpression.md` - Implement Aliasusageinfunctionexpression (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/done/821-implement-aliasUsageInFunctionExpression.md`
