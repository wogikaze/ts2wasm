...
- `issues/done/735-implement-assignmentIndexedToPrimitives.md` - Implement Assignmentindexedtoprimitives (same reference path, same feature label, same group key, title overlap)
...
`issues/done/735-implement-assignmentIndexedToPrimitives.md` に統合されました。
そちらを参照してください。
## Completion evidence
