---
id: 970
title: "Implement Assignmentindexedtoprimitives (dup)"
type: spike
...
- `issues/open/735-implement-assignmentIndexedToPrimitives.md` - Implement Assignmentindexedtoprimitives (same reference path, same feature label, same group key, title overlap)
...
`issues/open/735-implement-assignmentIndexedToPrimitives.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/970-implement-assignmentIndexedToPrimitives.md`
