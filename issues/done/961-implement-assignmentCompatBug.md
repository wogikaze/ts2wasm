---
id: 961
title: "Implement Assignmentcompatbug (dup)"
type: spike
...
- `issues/open/726-implement-assignmentCompatBug.md` - Implement Assignmentcompatbug (same reference path, same feature label, same group key, title overlap)
...
`issues/open/726-implement-assignmentCompatBug.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/961-implement-assignmentCompatBug.md`
