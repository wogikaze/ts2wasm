---
id: 972
title: "Implement Assignmentnonobjecttypeconstraints (dup)"
type: spike
...
- `issues/open/737-implement-assignmentNonObjectTypeConstraints.md` - Implement Assignmentnonobjecttypeconstraints (same reference path, same feature label, same group key, title overlap)
...
`issues/open/737-implement-assignmentNonObjectTypeConstraints.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/972-implement-assignmentNonObjectTypeConstraints.md`
