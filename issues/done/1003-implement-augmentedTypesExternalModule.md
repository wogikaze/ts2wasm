---
id: 1003
title: "Implement Augmentedtypesexternalmodule (dup)"
type: spike
...
- `issues/open/768-implement-augmentedTypesExternalModule.md` - Implement Augmentedtypesexternalmodule (same reference path, same feature label, same group key, title overlap)
...
`issues/open/768-implement-augmentedTypesExternalModule.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/1003-implement-augmentedTypesExternalModule.md`
