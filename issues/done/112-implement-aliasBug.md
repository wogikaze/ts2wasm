...
Reference test results show 1 cases fail in directory `aliasBug` with diagnostics: type-alias. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.
...
### Smart triage: Triage type alias: aliasBug
...
```json
{
  ...
  "message": "expected Semicolon, got Some(Ident(\"foo\")) at 54..57",
  "span_start": 54,
  "span_end": 57,
  "line": 4,
  "column": 14,
...
```text
error: [UnsupportedSyntax] expected Semicolon, got Some(Ident("foo")) at 54..57
```
...
Evidence files:
- `issues/done/112-implement-aliasBug.md`
