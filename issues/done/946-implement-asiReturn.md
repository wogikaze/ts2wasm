...
- `issues/open/711-implement-asiReturn.md` - Implement Asireturn (same reference path, same feature label, same group key, title overlap)
...
`issues/open/711-implement-asiReturn.md` に統合されました。
そちらを参照してください。
## Completion evidence
