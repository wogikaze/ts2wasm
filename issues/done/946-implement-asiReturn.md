...
- `issues/done/711-implement-asiReturn.md` - Implement Asireturn (same reference path, same feature label, same group key, title overlap)
...
`issues/done/711-implement-asiReturn.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/946-implement-asiReturn.md`
