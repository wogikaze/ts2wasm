...
- `issues/done/063-implement-function-resolution.md` - Implement function resolution (same feature label, same group key, title overlap)
...
- Implementation commits: verified via `git log --oneline --all --grep=431`
