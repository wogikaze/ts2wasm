...
- `issues/done/631-implement-amdLikeInputDeclarationEmit.md` - Implement Amdlikeinputdeclarationemit (same reference path, same feature label, same group key, title overlap)
...
`issues/done/631-implement-amdLikeInputDeclarationEmit.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/866-implement-amdLikeInputDeclarationEmit.md`
