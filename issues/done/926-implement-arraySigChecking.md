...
- `issues/open/691-implement-arraySigChecking.md` - Implement Arraysigchecking (same reference path, same feature label, same group key, title overlap)
...
`issues/open/691-implement-arraySigChecking.md` に統合されました。
そちらを参照してください。
## Completion evidence
