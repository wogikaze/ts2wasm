...
- `issues/done/772-implement-augmentedTypesVar.md` - Implement Augmentedtypesvar (same reference path, same feature label, same group key, title overlap)
...
`issues/done/772-implement-augmentedTypesVar.md` に統合されました。
そちらを参照してください。
## Completion evidence
