...
Superseded by issue #521. Duplicate from separate coverage run.
...
Evidence files:
- `issues/done/607-implement-ambientEnumElementInitializer.md` before this move
- `issues/done/607-implement-ambientEnumElementInitializer.md` after this move
...
Evidence files:
- `issues/done/607-implement-ambientEnumElementInitializer.md` after this correction
