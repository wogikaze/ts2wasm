...
- [x] updated: `issues/open/5226-allow-ambient-function-overload-declarations.md`
...
Fresh duplicate scan found exact owner `issues/open/5226-allow-ambient-function-overload-declarations.md`.
