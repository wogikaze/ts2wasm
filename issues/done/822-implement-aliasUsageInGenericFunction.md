...
- `issues/open/587-implement-aliasUsageInGenericFunction.md` - Implement Aliasusageingenericfunction (same reference path, same feature label, same group key, title overlap)
...
Evidence files:
- `issues/done/822-implement-aliasUsageInGenericFunction.md`
