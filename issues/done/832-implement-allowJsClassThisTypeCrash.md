...
- `issues/open/597-implement-allowJsClassThisTypeCrash.md` - Implement Allowjsclassthistypecrash (same reference path, same feature label, same group key, title overlap)
