...
- `issues/open/749-implement-asyncAwaitWithCapturedBlockScopeVar.md` - Implement Asyncawaitwithcapturedblockscopevar (same reference path, same feature label, same group key, title overlap)
...
`issues/open/749-implement-asyncAwaitWithCapturedBlockScopeVar.md` に統合されました。
そちらを参照してください。
## Completion evidence
