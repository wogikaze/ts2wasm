...
> Evidence: `git log --oneline --all --grep=152` shows only creation/chore commits — no feat/fix commit.
...
Failing test: `ambientExternalModuleWithRelativeExternalImportDeclaration.ts` — relative external import
