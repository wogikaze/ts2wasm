...
Evidence files:
- `issues/open/009-select-first-coverage-improvement-feature-slice.md` before this move
- `issues/open/009-select-first-coverage-improvement-feature-slice.md` after this move
