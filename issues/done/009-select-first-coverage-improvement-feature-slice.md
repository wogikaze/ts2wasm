...
- 2026-04-26: Added run evidence in `reports/runs/20260426-171214308/stdout.log`, `.../171214308/stderr.log`, `.../171517567/stdout.log`, and `.../171517567/stderr.log` showing `--detail` command outputs and unsupported-feature summary.
