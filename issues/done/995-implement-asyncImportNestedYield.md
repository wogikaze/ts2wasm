---
id: 995
title: "Implement Asyncimportnestedyield (dup)"
type: spike
...
- `issues/open/760-implement-asyncImportNestedYield.md` - Implement Asyncimportnestedyield (same reference path, same feature label, same group key, title overlap)
...
`issues/open/760-implement-asyncImportNestedYield.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/995-implement-asyncImportNestedYield.md`
