...
- `issues/done/760-implement-asyncImportNestedYield.md` - Implement Asyncimportnestedyield (same reference path, same feature label, same group key, title overlap)
...
`issues/done/760-implement-asyncImportNestedYield.md` に統合されました。
そちらを参照してください。
## Completion evidence
