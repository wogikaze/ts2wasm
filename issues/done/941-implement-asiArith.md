...
- `issues/done/706-implement-asiArith.md` - Implement Asiarith (same reference path, same feature label, same group key, title overlap)
...
`issues/done/706-implement-asiArith.md` に統合されました。
そちらを参照してください。
## Completion evidence
