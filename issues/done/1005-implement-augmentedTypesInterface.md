...
- `issues/done/770-implement-augmentedTypesInterface.md` - Implement Augmentedtypesinterface (same reference path, same feature label, same group key, title overlap)
...
`issues/done/770-implement-augmentedTypesInterface.md` に統合されました。
そちらを参照してください。
## Completion evidence
