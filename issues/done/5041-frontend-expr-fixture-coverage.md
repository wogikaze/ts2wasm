...
The audit gap was missing close evidence, not missing parser coverage.

Expr variants verified in `crates/frontend/src/ast.rs`:

- `LogicalAssign`
- `IndexAssign`
- `ClassExpr`

Coverage tests verified in `crates/frontend/src/parser/tests.rs`:

- `parses_logical_assignment_expression`
- `parses_index_assignment_expression`
- `parses_class_expression`
