---
id: 426
title: "Implement duplicate-function support"
type: spike
...
Triage duplicate-function feature across 8 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 8 cases fail with duplicate-function diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: duplicate-function feature has 8 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- test262 reference/test262/test/language/eval-code/direct/var-env-func-init-multi.js
```

Coverage window:

```sh
mise run reference-coverage -- test262 --path-filter reference/test262/test/language/eval-code/direct/var-env-func-init-multi.js --detail
```
...
- `reference/test262/test/language/statements/class/definition/accessors.js`
- `reference/test262/test/language/statements/class/definition/methods-restricted-properties.js`
...
### Smart triage: Triage duplicate function: var env func init multi

- Issue class: `triage-needed`
- Feature label: `duplicate-function`
- Diagnostic: `DuplicateFunction` / `compiler-diagnostic`
- Path: `reference/test262/test/language/eval-code/direct/var-env-func-init-multi.js`
...
```json
{
  ...
  "lines": 30,
  "extension": ".js",
  "first_code_line": "esid: sec-evaldeclarationinstantiation",
  "test262_metadata": {
...
```json
{
  ...
  "message": "duplicate function definition: `f` at 46..77",
  "span_start": 46,
  "span_end": 77,
  "line": 3,
  "column": 20,
...
```text
error: [DuplicateFunction] duplicate function definition: `f` at 46..77
```
    ...
    "diagnostics": [
      {
        "code": 6504,
        "category": "Error",
        "message": "File '/tmp/tmpu8qja2ww/test262-triage-node-input.js' is a JavaScript file. Did you mean to enable the 'allowJs' option?\n  The file is in the program because:\n    Root file specified for compilation"
      }
    ],
    "hints": [],
...
- Implementation commits: verified via `git log --oneline --all --grep=426`
