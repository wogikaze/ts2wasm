---
id: 983
title: "Implement Asyncarrowinclasses (dup)"
type: spike
...
- `issues/open/748-implement-asyncArrowInClassES.md` - Implement Asyncarrowinclasses (same reference path, same feature label, same group key, title overlap)
...
`issues/open/748-implement-asyncArrowInClassES.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/983-implement-asyncArrowInClassES.md`
