...
Triage type-system feature across 3 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 3 cases fail with type-system diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: type-system feature has 3 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- tsgo reference/typescript-go/testdata/tests/cases/compiler/genericArrowFunctionInEsmExtensionFile.ts
```

Coverage window:

```sh
mise run reference-coverage -- tsgo --path-filter reference/typescript-go/testdata/tests/cases/compiler/genericArrowFunctionInEsmExtensionFile.ts --detail
```
...
- `reference/typescript-go/testdata/tests/cases/compiler/genericArrowFunctionInEsmExtensionFile.ts`
- `reference/typescript-go/testdata/tests/cases/compiler/keyofUnresolvedBaseMembers.ts`
- `reference/typescript-go/testdata/tests/cases/compiler/templateLiteralMultiByteCharInference.ts`
