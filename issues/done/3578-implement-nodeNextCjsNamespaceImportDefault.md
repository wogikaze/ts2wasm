...
- `issues/open/5229-resolve-imports-between-filename-sections.md` is related to later local virtual section resolution, but the current stack first blocker is dependency export validation for `d`.
