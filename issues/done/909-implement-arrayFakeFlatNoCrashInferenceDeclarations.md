...
- `issues/done/674-implement-arrayFakeFlatNoCrashInferenceDeclarations.md` - Implement Arrayfakeflatnocrashinferencedeclarations (same reference path, same feature label, same group key, title overlap)
...
`issues/done/674-implement-arrayFakeFlatNoCrashInferenceDeclarations.md` に統合されました。
そちらを参照してください。
## Completion evidence
