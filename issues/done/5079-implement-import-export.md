...
Triage import-export feature across 1193 failing reference test cases and split this bucket into implementation-ready child issues.

## Problem

Reference test results show 1193 cases fail with import-export diagnostic. The compiler cannot handle these syntax/semantics, preventing compilation of code in this category.

Problem: import-export feature has 1193 reference failures and needs smart-triage evidence before implementation starts.
...
```sh
mise run reference-triage -- test262 reference/test262/test/built-ins/Proxy/preventExtensions/trap-is-undefined-target-is-proxy.js
```

Coverage window:

```sh
mise run reference-coverage -- test262 --path-filter reference/test262/test/built-ins/Proxy/preventExtensions/trap-is-undefined-target-is-proxy.js --detail
```
...
```sh
mise run reference-coverage -- test262 --limit 2386
mise run reference-coverage -- test262 --path-filter reference/test262/test/built-ins/Proxy/preventExtensions/trap-is-undefined-target-is-proxy.js --detail
mise run reference-triage -- test262 reference/test262/test/built-ins/Proxy/preventExtensions/trap-is-undefined-target-is-proxy.js
```
...
- `reference/test262/test/built-ins/Proxy/preventExtensions/trap-is-undefined-target-is-proxy.js`
...
Evidence files:
- `issues/done/5079-implement-import-export.md`
