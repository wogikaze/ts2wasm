...
- `issues/done/718-implement-assignToFn.md` - Implement Assigntofn (same reference path, same feature label, same group key, title overlap)
...
`issues/done/718-implement-assignToFn.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/953-implement-assignToFn.md`
