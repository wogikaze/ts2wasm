---
id: 980
title: "Implement Assignmenttoobjectandfunction (dup)"
type: spike
...
- `issues/open/745-implement-assignmentToObjectAndFunction.md` - Implement Assignmenttoobjectandfunction (same reference path, same feature label, same group key, title overlap)
...
`issues/open/745-implement-assignmentToObjectAndFunction.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/980-implement-assignmentToObjectAndFunction.md`
