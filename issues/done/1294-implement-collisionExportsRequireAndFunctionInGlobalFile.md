---
id: 1294
title: "Implement Collisionexportsrequireandfunctioninglobalfile"
type: spike
...
> Evidence: Empty completion evidence. No feat/fix commit for #1294.

## Summary

Closed as stale. Fresh triage and focused coverage show
`reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts`
...
`collisionExportsRequireAndFunctionInGlobalFile` with diagnostics:
...
```sh
python scripts/manager.py reference-triage tsc reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts
```

Coverage window:

```sh
python scripts/manager.py reference-coverage tsc --path-filter reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts --detail --no-dashboard-data
```
...
mise run reference-coverage -- tsc --path-filter reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts --detail
mise run reference-triage -- tsc reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts
```
...
### Smart triage: Build pass: collisionExportsRequireAndFunctionInGlobalFile

- Issue class: `none`
- Feature label: `build-pass`
- Diagnostic: `BuildPass` / `pass`
- Path: `reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts`
...
```text
tokens: ok; includes function exports/require and namespace m3/m4 function declarations
ast: ok; Function exports and Function require
resolved: ok; Function exports returns Number(1), Function require returns String("require")
visible symbols: function exports/require in global and namespace scopes
```
...
```text
command: python scripts/manager.py reference-triage tsc reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts
...
command: python scripts/manager.py reference-coverage tsc --path-filter reference/typescript/tests/cases/compiler/collisionExportsRequireAndFunctionInGlobalFile.ts --detail --no-dashboard-data
