---
id: 955
title: "Implement Assigntomodule (dup)"
type: spike
...
- `issues/open/720-implement-assignToModule.md` - Implement Assigntomodule (same reference path, same feature label, same group key, title overlap)
...
`issues/open/720-implement-assignToModule.md` に統合されました。
そちらを参照してください。
## Completion evidence
...
Evidence files:
- `issues/done/955-implement-assignToModule.md`
